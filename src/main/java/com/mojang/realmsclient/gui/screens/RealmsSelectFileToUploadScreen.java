...
public class RealmsSelectFileToUploadScreen extends RealmsScreen
{
    ...
    public void init()
    {
        ...
        catch (Exception exception)
        {
            ...
            this.minecraft.displayGuiScreen(new RealmsGenericErrorScreen(new StringTextComponent("Unable to load worlds"), ITextComponent.func_244388_a(exception.getMessage()), this.field_224548_b));
            return;
        }

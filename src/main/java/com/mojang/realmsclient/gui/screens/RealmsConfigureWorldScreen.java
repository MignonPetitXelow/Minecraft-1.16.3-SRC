...
public class RealmsConfigureWorldScreen extends NotifableRealmsScreen
{
    ...
    public void render(MatrixStack matrixStack, int mouseX, int mouseY, float partialTicks)
    {
        ...
        else
        {
            ...
            int k = this.font.func_238414_a_(field_243109_s);
    ...
    private void func_224387_a(long p_224387_1_)
    {
        (new Thread(() ->
        {
            ...
            catch (RealmsServiceException realmsserviceexception)
            {
                ...
                {
                    this.minecraft.displayGuiScreen(new RealmsGenericErrorScreen(ITextComponent.func_244388_a(realmsserviceexception.getMessage()), this.field_224415_c));
                });
            }
        })).start();
    }
    ...
    protected void func_237796_a_(MatrixStack p_237796_1_, @Nullable ITextComponent p_237796_2_, int p_237796_3_, int p_237796_4_)
    {
        ...
        int k = this.font.func_238414_a_(p_237796_2_);

...
public class GlStateManager
{
    ...
    {
        if (p_227747_0_ != clientActiveTexture)
        {
            RenderSystem.assertThread(RenderSystem::isOnRenderThread);
            GL13.glClientActiveTexture(p_227747_0_);
            clientActiveTexture = p_227747_0_;
        }
    }
    ...
    public static void func_237512_a_(Vector3f p_237512_0_, Vector3f p_237512_1_, Matrix4f p_237512_2_)
    {
        RenderSystem.assertThread(RenderSystem::isOnRenderThread);
        pushMatrix();
        loadIdentity();
    ...
    public static void func_237511_a_(Vector3f p_237511_0_, Vector3f p_237511_1_)
    {
        RenderSystem.assertThread(RenderSystem::isOnRenderThread);
        ...
        func_237512_a_(p_237511_0_, p_237511_1_, matrix4f);
    }

    public static void func_237513_b_(Vector3f p_237513_0_, Vector3f p_237513_1_)
    {
        RenderSystem.assertThread(RenderSystem::isOnRenderThread);
        Matrix4f matrix4f = new Matrix4f();
        matrix4f.setIdentity();
        ...
        matrix4f.mul(Vector3f.YP.rotationDegrees(-22.5F));
        matrix4f.mul(Vector3f.XP.rotationDegrees(135.0F));
        func_237512_a_(p_237513_0_, p_237513_1_, matrix4f);
    }
    ...
    public static void func_242998_a(int[] p_242998_0_)
    {
        RenderSystem.assertThread(RenderSystem::isOnRenderThreadOrInit);
    ...
    public static void func_242999_b(int[] p_242999_0_)
    {
        RenderSystem.assertThread(RenderSystem::isOnRenderThreadOrInit);

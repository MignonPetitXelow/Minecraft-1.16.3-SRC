...
public class Alternative implements ILootCondition
{
    ...
    {
        public void func_230424_a_(JsonObject p_230424_1_, Alternative p_230424_2_, JsonSerializationContext p_230424_3_)
        {
            p_230424_1_.add("terms", p_230424_3_.serialize(p_230424_2_.conditions));
        }

        public Alternative func_230423_a_(JsonObject p_230423_1_, JsonDeserializationContext p_230423_2_)
        {

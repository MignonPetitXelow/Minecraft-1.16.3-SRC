...
public class MatchTool implements ILootCondition
{
    ...
    {
        public void func_230424_a_(JsonObject p_230424_1_, MatchTool p_230424_2_, JsonSerializationContext p_230424_3_)
        {
            p_230424_1_.add("predicate", p_230424_2_.predicate.serialize());
        }

        public MatchTool func_230423_a_(JsonObject p_230423_1_, JsonDeserializationContext p_230423_2_)
        {

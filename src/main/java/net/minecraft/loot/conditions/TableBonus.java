...
public class TableBonus implements ILootCondition
{
    ...
    {
        public void func_230424_a_(JsonObject p_230424_1_, TableBonus p_230424_2_, JsonSerializationContext p_230424_3_)
        {
        ...
        public TableBonus func_230423_a_(JsonObject p_230423_1_, JsonDeserializationContext p_230423_2_)
        {
            ResourceLocation resourcelocation = new ResourceLocation(JSONUtils.getString(p_230423_1_, "enchantment"));
            Enchantment enchantment = Registry.ENCHANTMENT.func_241873_b(resourcelocation).orElseThrow(() ->
            {

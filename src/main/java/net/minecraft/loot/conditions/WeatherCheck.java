...
public class WeatherCheck implements ILootCondition
{
    ...
    {
        public void func_230424_a_(JsonObject p_230424_1_, WeatherCheck p_230424_2_, JsonSerializationContext p_230424_3_)
        {
            p_230424_1_.addProperty("raining", p_230424_2_.raining);
            p_230424_1_.addProperty("thundering", p_230424_2_.thundering);
        }

        public WeatherCheck func_230423_a_(JsonObject p_230423_1_, JsonDeserializationContext p_230423_2_)
        {

...
public class Inverted implements ILootCondition
{
    ...
    {
        public void func_230424_a_(JsonObject p_230424_1_, Inverted p_230424_2_, JsonSerializationContext p_230424_3_)
        {
            p_230424_1_.add("term", p_230424_3_.serialize(p_230424_2_.term));
        }

        public Inverted func_230423_a_(JsonObject p_230423_1_, JsonDeserializationContext p_230423_2_)
        {

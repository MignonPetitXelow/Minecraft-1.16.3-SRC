...
public class RandomChance implements ILootCondition
{
    ...
    {
        public void func_230424_a_(JsonObject p_230424_1_, RandomChance p_230424_2_, JsonSerializationContext p_230424_3_)
        {
            p_230424_1_.addProperty("chance", p_230424_2_.chance);
        }

        public RandomChance func_230423_a_(JsonObject p_230423_1_, JsonDeserializationContext p_230423_2_)
        {

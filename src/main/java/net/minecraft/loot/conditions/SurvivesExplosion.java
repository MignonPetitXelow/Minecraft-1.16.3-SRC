...
public class SurvivesExplosion implements ILootCondition
{
    ...
    {
        public void func_230424_a_(JsonObject p_230424_1_, SurvivesExplosion p_230424_2_, JsonSerializationContext p_230424_3_)
        {
        }

        public SurvivesExplosion func_230423_a_(JsonObject p_230423_1_, JsonDeserializationContext p_230423_2_)
        {

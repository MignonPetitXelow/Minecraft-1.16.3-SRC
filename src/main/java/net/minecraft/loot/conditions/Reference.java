...
public class Reference implements ILootCondition
{
    ...
    {
        public void func_230424_a_(JsonObject p_230424_1_, Reference p_230424_2_, JsonSerializationContext p_230424_3_)
        {
            p_230424_1_.addProperty("name", p_230424_2_.field_227562_b_.toString());
        }

        public Reference func_230423_a_(JsonObject p_230423_1_, JsonDeserializationContext p_230423_2_)
        {

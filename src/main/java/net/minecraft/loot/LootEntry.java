...
public abstract class LootEntry implements ILootEntry
{
    ...
    {
        public final void func_230424_a_(JsonObject p_230424_1_, T p_230424_2_, JsonSerializationContext p_230424_3_)
        {
            ...
            this.func_230422_a_(p_230424_1_, p_230424_2_, p_230424_3_);
        }

        public final T func_230423_a_(JsonObject p_230423_1_, JsonDeserializationContext p_230423_2_)
        {
            ...
            return this.func_230421_b_(p_230423_1_, p_230423_2_, ailootcondition);
        }

        public abstract void func_230422_a_(JsonObject p_230422_1_, T p_230422_2_, JsonSerializationContext p_230422_3_);

        public abstract T func_230421_b_(JsonObject p_230421_1_, JsonDeserializationContext p_230421_2_, ILootCondition[] p_230421_3_);
    }
}

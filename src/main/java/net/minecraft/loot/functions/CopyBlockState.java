...
public class CopyBlockState extends LootFunction
{
    ...
    {
        public void func_230424_a_(JsonObject p_230424_1_, CopyBlockState p_230424_2_, JsonSerializationContext p_230424_3_)
        {
        ...
        public CopyBlockState deserialize(JsonObject object, JsonDeserializationContext deserializationContext, ILootCondition[] conditionsIn)
        {
            ...
            Block block = Registry.BLOCK.func_241873_b(resourcelocation).orElseThrow(() ->
            {

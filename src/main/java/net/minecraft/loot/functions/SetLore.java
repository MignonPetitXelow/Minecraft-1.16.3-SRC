...
public class SetLore extends LootFunction
{
    ...
    {
        public void func_230424_a_(JsonObject p_230424_1_, SetLore p_230424_2_, JsonSerializationContext p_230424_3_)
        {
        ...
        public SetLore deserialize(JsonObject object, JsonDeserializationContext deserializationContext, ILootCondition[] conditionsIn)
        {
            ...
            List<ITextComponent> list = Streams.stream(JSONUtils.getJsonArray(object, "lore")).map(ITextComponent.Serializer::func_240641_a_).collect(ImmutableList.toImmutableList());

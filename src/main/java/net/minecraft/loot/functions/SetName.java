...
public class SetName extends LootFunction
{
    ...
    {
        public void func_230424_a_(JsonObject p_230424_1_, SetName p_230424_2_, JsonSerializationContext p_230424_3_)
        {
        ...
        {
            ITextComponent itextcomponent = ITextComponent.Serializer.func_240641_a_(object.get("name"));

...
public class MapData extends WorldSavedData
{
    ...
    {
        this.dimension = DimensionType.func_236025_a_(new Dynamic<>(NBTDynamicOps.INSTANCE, nbt.get("dimension"))).resultOrPartial(LOGGER::error).orElseThrow(() ->
        {
    ...
    {
        ResourceLocation.CODEC.encodeStart(NBTDynamicOps.INSTANCE, this.dimension.func_240901_a_()).resultOrPartial(LOGGER::error).ifPresent((dimNBT) ->
        {

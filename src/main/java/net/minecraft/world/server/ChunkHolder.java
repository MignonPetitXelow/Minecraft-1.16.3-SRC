...
public class ChunkHolder
{
    ...
    public Chunk getChunkIfComplete()
    {
        ...
        Either<Chunk, ChunkHolder.IChunkLoadingError> either = completablefuture.getNow((Either)null);
            ...
            for (int k = 0; k < this.field_244383_q.length; ++k)
            {
                ...
                if (shortset != null)
                {
                    ...
                    else
                    {
                        ...
                        smultiblockchangepacket.func_244310_a((p_lambda$sendChanges$0_2_, p_lambda$sendChanges$0_3_) ->
                        {
                            this.func_244385_a(world, p_lambda$sendChanges$0_2_, p_lambda$sendChanges$0_3_);
                        });
                    }
    ...
    {
        if (ReflectorForge.blockHasTileEntity(p_244385_3_))
        {
    ...
    {
        this.playerProvider.getTrackingPlayers(this.pos, boundaryOnly).forEach((p_lambda$sendToTracking$1_1_) ->
        {
            p_lambda$sendToTracking$1_1_.connection.sendPacket(packetIn);
        });
    }
    ...
    public CompletableFuture<Either<IChunk, ChunkHolder.IChunkLoadingError>> func_219276_a(ChunkStatus p_219276_1_, ChunkManager p_219276_2_)
    {
        ...
        {
            Either<IChunk, ChunkHolder.IChunkLoadingError> either = completablefuture.getNow((Either)null);
    ...
    {
        this.field_219315_j = this.field_219315_j.thenCombine(eitherChunk, (p_lambda$chain$4_0_, p_lambda$chain$4_1_) ->
        {
            return p_lambda$chain$4_1_.map((p_lambda$null$2_0_) -> {
                return p_lambda$null$2_0_;
            }, (p_lambda$null$3_1_) -> {
                return p_lambda$chain$4_0_;
            });
        });
    }
    ...
    protected void processUpdates(ChunkManager chunkManagerIn)
    {
        ...
        if (flag5 && !flag6)
        {
            ...
            this.chain(completablefuture1.thenApply((p_lambda$processUpdates$5_1_) ->
            {
                return p_lambda$processUpdates$5_1_.ifLeft(chunkManagerIn::func_222973_a);
            }));
        }
    ...
    {
        return level < 65 ? ChunkStatus.FULL : ChunkStatus.getStatus(level - 65);
    }

    public static ChunkHolder.LocationType getLocationTypeFromLevel(int level)
    {
        return LOCATION_TYPES[MathHelper.clamp(65 - level + 1, 0, LOCATION_TYPES.length - 1)];
    }

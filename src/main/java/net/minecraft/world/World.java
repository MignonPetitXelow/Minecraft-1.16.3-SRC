...
public abstract class World implements IWorld, AutoCloseable
{
    ...
    public static final Codec<RegistryKey<World>> CODEC = ResourceLocation.CODEC.xmap(RegistryKey.func_240902_a_(Registry.WORLD_KEY), RegistryKey::func_240901_a_);
    public static final RegistryKey<World> OVERWORLD = RegistryKey.func_240903_a_(Registry.WORLD_KEY, new ResourceLocation("overworld"));
    public static final RegistryKey<World> THE_NETHER = RegistryKey.func_240903_a_(Registry.WORLD_KEY, new ResourceLocation("the_nether"));
    public static final RegistryKey<World> THE_END = RegistryKey.func_240903_a_(Registry.WORLD_KEY, new ResourceLocation("the_end"));
    ...
    protected World(ISpawnWorldInfo p_i241925_1_, RegistryKey<World> p_i241925_2_, final DimensionType p_i241925_3_, Supplier<IProfiler> p_i241925_4_, boolean p_i241925_5_, boolean p_i241925_6_, long p_i241925_7_)
    {
        ...
        if (p_i241925_3_.func_242724_f() != 1.0D)
        {
            this.worldBorder = new WorldBorder()
            {
                ...
                {
                    return super.getCenterX() / p_i241925_3_.func_242724_f();
                }
                public double getCenterZ()
                {
                    return super.getCenterZ() / p_i241925_3_.func_242724_f();
                }
            };
        }
        else
    ...
    public CrashReportCategory fillCrashReport(CrashReport report)
    {
        ...
        {
            return this.getDimensionKey().func_240901_a_().toString();
        });

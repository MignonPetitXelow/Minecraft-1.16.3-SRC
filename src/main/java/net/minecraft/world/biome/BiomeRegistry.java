...
public abstract class BiomeRegistry
{
    ...
    static
    {
        ...
        func_244204_a(8, Biomes.NETHER_WASTES, BiomeMaker.func_244253_s());
        ...
        func_244204_a(170, Biomes.SOUL_SAND_VALLEY, BiomeMaker.func_244254_t());
        func_244204_a(171, Biomes.CRIMSON_FOREST, BiomeMaker.func_244256_v());
        func_244204_a(172, Biomes.WARPED_FOREST, BiomeMaker.func_244257_w());
        func_244204_a(173, Biomes.BASALT_DELTAS, BiomeMaker.func_244255_u());
    }
}

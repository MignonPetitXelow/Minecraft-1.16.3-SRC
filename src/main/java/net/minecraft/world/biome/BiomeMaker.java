...
public class BiomeMaker
{
    ...
    public static Biome func_244210_a(float p_244210_0_, float p_244210_1_, float p_244210_2_, boolean p_244210_3_)
    {
        ...
        return (new Biome.Builder()).precipitation(Biome.RainType.RAIN).category(Biome.Category.TAIGA).depth(p_244210_0_).scale(p_244210_1_).temperature(p_244210_2_).downfall(0.8F).func_235097_a_((new BiomeAmbience.Builder()).setWaterColor(4159204).setWaterFogColor(329011).setFogColor(12638463).func_242539_d(func_244206_a(p_244210_2_)).setMoodSound(MoodSoundAmbience.field_235027_b_).build()).func_242458_a(mobspawninfo$builder.func_242577_b()).func_242457_a(biomegenerationsettings$builder.func_242508_a()).func_242455_a();
    }
    ...
    private static Biome func_244213_a(float p_244213_0_, float p_244213_1_, float p_244213_2_, boolean p_244213_3_, boolean p_244213_4_, boolean p_244213_5_, MobSpawnInfo.Builder p_244213_6_)
    {
        ...
        DefaultBiomeFeatures.func_243730_an(biomegenerationsettings$builder);
        return (new Biome.Builder()).precipitation(Biome.RainType.RAIN).category(Biome.Category.JUNGLE).depth(p_244213_0_).scale(p_244213_1_).temperature(0.95F).downfall(p_244213_2_).func_235097_a_((new BiomeAmbience.Builder()).setWaterColor(4159204).setWaterFogColor(329011).setFogColor(12638463).func_242539_d(func_244206_a(0.95F)).setMoodSound(MoodSoundAmbience.field_235027_b_).build()).func_242458_a(p_244213_6_.func_242577_b()).func_242457_a(biomegenerationsettings$builder.func_242508_a()).func_242455_a();
    }
    ...
    public static Biome func_244220_a(float p_244220_0_, float p_244220_1_, boolean p_244220_2_, boolean p_244220_3_, boolean p_244220_4_)
    {
        ...
        DefaultBiomeFeatures.func_243730_an(biomegenerationsettings$builder);
        return (new Biome.Builder()).precipitation(Biome.RainType.NONE).category(Biome.Category.DESERT).depth(p_244220_0_).scale(p_244220_1_).temperature(2.0F).downfall(0.0F).func_235097_a_((new BiomeAmbience.Builder()).setWaterColor(4159204).setWaterFogColor(329011).setFogColor(12638463).func_242539_d(func_244206_a(2.0F)).setMoodSound(MoodSoundAmbience.field_235027_b_).build()).func_242458_a(mobspawninfo$builder.func_242577_b()).func_242457_a(biomegenerationsettings$builder.func_242508_a()).func_242455_a();
    }
    ...
    private static Biome func_244222_a(BiomeGenerationSettings.Builder p_244222_0_)
    {
        ...
        return (new Biome.Builder()).precipitation(Biome.RainType.NONE).category(Biome.Category.THEEND).depth(0.1F).scale(0.2F).temperature(0.5F).downfall(0.5F).func_235097_a_((new BiomeAmbience.Builder()).setWaterColor(4159204).setWaterFogColor(329011).setFogColor(10518688).func_242539_d(0).setMoodSound(MoodSoundAmbience.field_235027_b_).build()).func_242458_a(mobspawninfo$builder.func_242577_b()).func_242457_a(p_244222_0_.func_242508_a()).func_242455_a();
    }
    ...
    public static Biome func_244207_a(float p_244207_0_, float p_244207_1_)
    {
        ...
        DefaultBiomeFeatures.func_243727_ak(biomegenerationsettings$builder);
        DefaultBiomeFeatures.func_243730_an(biomegenerationsettings$builder);
        return (new Biome.Builder()).precipitation(Biome.RainType.RAIN).category(Biome.Category.MUSHROOM).depth(p_244207_0_).scale(p_244207_1_).temperature(0.9F).downfall(1.0F).func_235097_a_((new BiomeAmbience.Builder()).setWaterColor(4159204).setWaterFogColor(329011).setFogColor(12638463).func_242539_d(func_244206_a(0.9F)).setMoodSound(MoodSoundAmbience.field_235027_b_).build()).func_242458_a(mobspawninfo$builder.func_242577_b()).func_242457_a(biomegenerationsettings$builder.func_242508_a()).func_242455_a();
    }
    ...
    private static Biome func_244212_a(float p_244212_0_, float p_244212_1_, float p_244212_2_, boolean p_244212_3_, boolean p_244212_4_, MobSpawnInfo.Builder p_244212_5_)
    {
        ...
        DefaultBiomeFeatures.func_243727_ak(biomegenerationsettings$builder);
        DefaultBiomeFeatures.func_243730_an(biomegenerationsettings$builder);
        return (new Biome.Builder()).precipitation(Biome.RainType.NONE).category(Biome.Category.SAVANNA).depth(p_244212_0_).scale(p_244212_1_).temperature(p_244212_2_).downfall(0.0F).func_235097_a_((new BiomeAmbience.Builder()).setWaterColor(4159204).setWaterFogColor(329011).setFogColor(12638463).func_242539_d(func_244206_a(p_244212_2_)).setMoodSound(MoodSoundAmbience.field_235027_b_).build()).func_242458_a(p_244212_5_.func_242577_b()).func_242457_a(biomegenerationsettings$builder.func_242508_a()).func_242455_a();
    }
    ...
    private static Biome func_244224_a(ConfiguredSurfaceBuilder<SurfaceBuilderConfig> p_244224_0_, float p_244224_1_, float p_244224_2_, boolean p_244224_3_, boolean p_244224_4_)
    {
        ...
        DefaultBiomeFeatures.func_243727_ak(biomegenerationsettings$builder);
        DefaultBiomeFeatures.func_243730_an(biomegenerationsettings$builder);
        return (new Biome.Builder()).precipitation(Biome.RainType.NONE).category(Biome.Category.MESA).depth(p_244224_1_).scale(p_244224_2_).temperature(2.0F).downfall(0.0F).func_235097_a_((new BiomeAmbience.Builder()).setWaterColor(4159204).setWaterFogColor(329011).setFogColor(12638463).func_242539_d(func_244206_a(2.0F)).func_242540_e(10387789).func_242541_f(9470285).setMoodSound(MoodSoundAmbience.field_235027_b_).build()).func_242458_a(mobspawninfo$builder.func_242577_b()).func_242457_a(biomegenerationsettings$builder.func_242508_a()).func_242455_a();
    }
    ...
    {
        return (new Biome.Builder()).precipitation(Biome.RainType.RAIN).category(Biome.Category.OCEAN).depth(p_244223_3_ ? -1.8F : -1.0F).scale(0.1F).temperature(0.5F).downfall(0.5F).func_235097_a_((new BiomeAmbience.Builder()).setWaterColor(p_244223_1_).setWaterFogColor(p_244223_2_).setFogColor(12638463).func_242539_d(func_244206_a(0.5F)).setMoodSound(MoodSoundAmbience.field_235027_b_).build()).func_242458_a(p_244223_0_.func_242577_b()).func_242457_a(p_244223_4_.func_242508_a()).func_242455_a();
    }
    ...
    public static Biome func_244239_e(boolean p_244239_0_)
    {
        ...
        DefaultBiomeFeatures.func_243727_ak(biomegenerationsettings$builder);
        DefaultBiomeFeatures.func_243730_an(biomegenerationsettings$builder);
        return (new Biome.Builder()).precipitation(p_244239_0_ ? Biome.RainType.RAIN : Biome.RainType.SNOW).category(Biome.Category.OCEAN).depth(p_244239_0_ ? -1.8F : -1.0F).scale(0.1F).temperature(f).func_242456_a(Biome.TemperatureModifier.FROZEN).downfall(0.5F).func_235097_a_((new BiomeAmbience.Builder()).setWaterColor(3750089).setWaterFogColor(329011).setFogColor(12638463).func_242539_d(func_244206_a(f)).setMoodSound(MoodSoundAmbience.field_235027_b_).build()).func_242458_a(mobspawninfo$builder.func_242577_b()).func_242457_a(biomegenerationsettings$builder.func_242508_a()).func_242455_a();
    }
    ...
    private static Biome func_244218_a(float p_244218_0_, float p_244218_1_, boolean p_244218_2_, MobSpawnInfo.Builder p_244218_3_)
    {
        ...
        DefaultBiomeFeatures.func_243727_ak(biomegenerationsettings$builder);
        DefaultBiomeFeatures.func_243730_an(biomegenerationsettings$builder);
        return (new Biome.Builder()).precipitation(Biome.RainType.RAIN).category(Biome.Category.FOREST).depth(p_244218_0_).scale(p_244218_1_).temperature(0.7F).downfall(0.8F).func_235097_a_((new BiomeAmbience.Builder()).setWaterColor(4159204).setWaterFogColor(329011).setFogColor(12638463).func_242539_d(func_244206_a(0.7F)).setMoodSound(MoodSoundAmbience.field_235027_b_).build()).func_242458_a(p_244218_3_.func_242577_b()).func_242457_a(biomegenerationsettings$builder.func_242508_a()).func_242455_a();
    }
    ...
    public static Biome func_244233_c(float p_244233_0_, float p_244233_1_, boolean p_244233_2_)
    {
        ...
        DefaultBiomeFeatures.func_243727_ak(biomegenerationsettings$builder);
        DefaultBiomeFeatures.func_243730_an(biomegenerationsettings$builder);
        return (new Biome.Builder()).precipitation(Biome.RainType.RAIN).category(Biome.Category.FOREST).depth(p_244233_0_).scale(p_244233_1_).temperature(0.7F).downfall(0.8F).func_235097_a_((new BiomeAmbience.Builder()).setWaterColor(4159204).setWaterFogColor(329011).setFogColor(12638463).func_242539_d(func_244206_a(0.7F)).func_242537_a(BiomeAmbience.GrassColorModifier.DARK_FOREST).setMoodSound(MoodSoundAmbience.field_235027_b_).build()).func_242458_a(mobspawninfo$builder.func_242577_b()).func_242457_a(biomegenerationsettings$builder.func_242508_a()).func_242455_a();
    }
    ...
    public static Biome func_244219_a(float p_244219_0_, float p_244219_1_, boolean p_244219_2_, boolean p_244219_3_)
    {
        ...
        DefaultBiomeFeatures.func_243727_ak(biomegenerationsettings$builder);
        DefaultBiomeFeatures.func_243730_an(biomegenerationsettings$builder);
        return (new Biome.Builder()).precipitation(Biome.RainType.SNOW).category(Biome.Category.ICY).depth(p_244219_0_).scale(p_244219_1_).temperature(0.0F).downfall(0.5F).func_235097_a_((new BiomeAmbience.Builder()).setWaterColor(4159204).setWaterFogColor(329011).setFogColor(12638463).func_242539_d(func_244206_a(0.0F)).setMoodSound(MoodSoundAmbience.field_235027_b_).build()).func_242458_a(mobspawninfo$builder.func_242577_b()).func_242457_a(biomegenerationsettings$builder.func_242508_a()).func_242455_a();
    }
    ...
    public static Biome func_244209_a(float p_244209_0_, float p_244209_1_, float p_244209_2_, int p_244209_3_, boolean p_244209_4_)
    {
        ...
        DefaultBiomeFeatures.func_243730_an(biomegenerationsettings$builder);
        return (new Biome.Builder()).precipitation(p_244209_4_ ? Biome.RainType.SNOW : Biome.RainType.RAIN).category(Biome.Category.RIVER).depth(p_244209_0_).scale(p_244209_1_).temperature(p_244209_2_).downfall(0.5F).func_235097_a_((new BiomeAmbience.Builder()).setWaterColor(p_244209_3_).setWaterFogColor(329011).setFogColor(12638463).func_242539_d(func_244206_a(p_244209_2_)).setMoodSound(MoodSoundAmbience.field_235027_b_).build()).func_242458_a(mobspawninfo$builder.func_242577_b()).func_242457_a(biomegenerationsettings$builder.func_242508_a()).func_242455_a();
    }
    ...
    public static Biome func_244208_a(float p_244208_0_, float p_244208_1_, float p_244208_2_, float p_244208_3_, int p_244208_4_, boolean p_244208_5_, boolean p_244208_6_)
    {
        ...
        DefaultBiomeFeatures.func_243727_ak(biomegenerationsettings$builder);
        DefaultBiomeFeatures.func_243730_an(biomegenerationsettings$builder);
        return (new Biome.Builder()).precipitation(p_244208_5_ ? Biome.RainType.SNOW : Biome.RainType.RAIN).category(p_244208_6_ ? Biome.Category.NONE : Biome.Category.BEACH).depth(p_244208_0_).scale(p_244208_1_).temperature(p_244208_2_).downfall(p_244208_3_).func_235097_a_((new BiomeAmbience.Builder()).setWaterColor(p_244208_4_).setWaterFogColor(329011).setFogColor(12638463).func_242539_d(func_244206_a(p_244208_2_)).setMoodSound(MoodSoundAmbience.field_235027_b_).build()).func_242458_a(mobspawninfo$builder.func_242577_b()).func_242457_a(biomegenerationsettings$builder.func_242508_a()).func_242455_a();
    }
    ...
    public static Biome func_244252_r()
    {
        ...
        return (new Biome.Builder()).precipitation(Biome.RainType.NONE).category(Biome.Category.NONE).depth(0.1F).scale(0.2F).temperature(0.5F).downfall(0.5F).func_235097_a_((new BiomeAmbience.Builder()).setWaterColor(4159204).setWaterFogColor(329011).setFogColor(12638463).func_242539_d(func_244206_a(0.5F)).setMoodSound(MoodSoundAmbience.field_235027_b_).build()).func_242458_a(MobSpawnInfo.field_242551_b).func_242457_a(biomegenerationsettings$builder.func_242508_a()).func_242455_a();
    }

    public static Biome func_244253_s()
    {
        MobSpawnInfo mobspawninfo = (new MobSpawnInfo.Builder()).func_242575_a(EntityClassification.MONSTER, new MobSpawnInfo.Spawners(EntityType.GHAST, 50, 4, 4)).func_242575_a(EntityClassification.MONSTER, new MobSpawnInfo.Spawners(EntityType.ZOMBIFIED_PIGLIN, 100, 4, 4)).func_242575_a(EntityClassification.MONSTER, new MobSpawnInfo.Spawners(EntityType.MAGMA_CUBE, 2, 4, 4)).func_242575_a(EntityClassification.MONSTER, new MobSpawnInfo.Spawners(EntityType.ENDERMAN, 1, 4, 4)).func_242575_a(EntityClassification.MONSTER, new MobSpawnInfo.Spawners(EntityType.PIGLIN, 15, 4, 4)).func_242575_a(EntityClassification.CREATURE, new MobSpawnInfo.Spawners(EntityType.STRIDER, 60, 1, 2)).func_242577_b();
        ...
        return (new Biome.Builder()).precipitation(Biome.RainType.NONE).category(Biome.Category.NETHER).depth(0.1F).scale(0.2F).temperature(2.0F).downfall(0.0F).func_235097_a_((new BiomeAmbience.Builder()).setWaterColor(4159204).setWaterFogColor(329011).setFogColor(3344392).func_242539_d(func_244206_a(2.0F)).setAmbientSound(SoundEvents.AMBIENT_NETHER_WASTES_LOOP).setMoodSound(new MoodSoundAmbience(SoundEvents.AMBIENT_NETHER_WASTES_MOOD, 6000, 8, 2.0D)).setAdditionsSound(new SoundAdditionsAmbience(SoundEvents.AMBIENT_NETHER_WASTES_ADDITIONS, 0.0111D)).setMusic(BackgroundMusicTracks.getDefaultBackgroundMusicSelector(SoundEvents.MUSIC_NETHER_NETHER_WASTES)).build()).func_242458_a(mobspawninfo).func_242457_a(biomegenerationsettings$builder.func_242508_a()).func_242455_a();
    }
    ...
    public static Biome func_244254_t()
    {
        double d0 = 0.7D;
        double d1 = 0.15D;
        MobSpawnInfo mobspawninfo = (new MobSpawnInfo.Builder()).func_242575_a(EntityClassification.MONSTER, new MobSpawnInfo.Spawners(EntityType.SKELETON, 20, 5, 5)).func_242575_a(EntityClassification.MONSTER, new MobSpawnInfo.Spawners(EntityType.GHAST, 50, 4, 4)).func_242575_a(EntityClassification.MONSTER, new MobSpawnInfo.Spawners(EntityType.ENDERMAN, 1, 4, 4)).func_242575_a(EntityClassification.CREATURE, new MobSpawnInfo.Spawners(EntityType.STRIDER, 60, 1, 2)).func_242573_a(EntityType.SKELETON, 0.7D, 0.15D).func_242573_a(EntityType.GHAST, 0.7D, 0.15D).func_242573_a(EntityType.ENDERMAN, 0.7D, 0.15D).func_242573_a(EntityType.STRIDER, 0.7D, 0.15D).func_242577_b();
        ...
        DefaultBiomeFeatures.func_243731_ao(biomegenerationsettings$builder);
        return (new Biome.Builder()).precipitation(Biome.RainType.NONE).category(Biome.Category.NETHER).depth(0.1F).scale(0.2F).temperature(2.0F).downfall(0.0F).func_235097_a_((new BiomeAmbience.Builder()).setWaterColor(4159204).setWaterFogColor(329011).setFogColor(1787717).func_242539_d(func_244206_a(2.0F)).setParticle(new ParticleEffectAmbience(ParticleTypes.ASH, 0.00625F)).setAmbientSound(SoundEvents.AMBIENT_SOUL_SAND_VALLEY_LOOP).setMoodSound(new MoodSoundAmbience(SoundEvents.AMBIENT_SOUL_SAND_VALLEY_MOOD, 6000, 8, 2.0D)).setAdditionsSound(new SoundAdditionsAmbience(SoundEvents.AMBIENT_SOUL_SAND_VALLEY_ADDITIONS, 0.0111D)).setMusic(BackgroundMusicTracks.getDefaultBackgroundMusicSelector(SoundEvents.MUSIC_NETHER_SOUL_SAND_VALLEY)).build()).func_242458_a(mobspawninfo).func_242457_a(biomegenerationsettings$builder.func_242508_a()).func_242455_a();
    }

    public static Biome func_244255_u()
    {
        MobSpawnInfo mobspawninfo = (new MobSpawnInfo.Builder()).func_242575_a(EntityClassification.MONSTER, new MobSpawnInfo.Spawners(EntityType.GHAST, 40, 1, 1)).func_242575_a(EntityClassification.MONSTER, new MobSpawnInfo.Spawners(EntityType.MAGMA_CUBE, 100, 2, 5)).func_242575_a(EntityClassification.CREATURE, new MobSpawnInfo.Spawners(EntityType.STRIDER, 60, 1, 2)).func_242577_b();
        ...
        return (new Biome.Builder()).precipitation(Biome.RainType.NONE).category(Biome.Category.NETHER).depth(0.1F).scale(0.2F).temperature(2.0F).downfall(0.0F).func_235097_a_((new BiomeAmbience.Builder()).setWaterColor(4159204).setWaterFogColor(4341314).setFogColor(6840176).func_242539_d(func_244206_a(2.0F)).setParticle(new ParticleEffectAmbience(ParticleTypes.WHITE_ASH, 0.118093334F)).setAmbientSound(SoundEvents.AMBIENT_BASALT_DELTAS_LOOP).setMoodSound(new MoodSoundAmbience(SoundEvents.AMBIENT_BASALT_DELTAS_MOOD, 6000, 8, 2.0D)).setAdditionsSound(new SoundAdditionsAmbience(SoundEvents.AMBIENT_BASALT_DELTAS_ADDITIONS, 0.0111D)).setMusic(BackgroundMusicTracks.getDefaultBackgroundMusicSelector(SoundEvents.MUSIC_NETHER_BASALT_DELTAS)).build()).func_242458_a(mobspawninfo).func_242457_a(biomegenerationsettings$builder.func_242508_a()).func_242455_a();
    }

    public static Biome func_244256_v()
    {
        MobSpawnInfo mobspawninfo = (new MobSpawnInfo.Builder()).func_242575_a(EntityClassification.MONSTER, new MobSpawnInfo.Spawners(EntityType.ZOMBIFIED_PIGLIN, 1, 2, 4)).func_242575_a(EntityClassification.MONSTER, new MobSpawnInfo.Spawners(EntityType.HOGLIN, 9, 3, 4)).func_242575_a(EntityClassification.MONSTER, new MobSpawnInfo.Spawners(EntityType.PIGLIN, 5, 3, 4)).func_242575_a(EntityClassification.CREATURE, new MobSpawnInfo.Spawners(EntityType.STRIDER, 60, 1, 2)).func_242577_b();
        ...
        DefaultBiomeFeatures.func_243731_ao(biomegenerationsettings$builder);
        return (new Biome.Builder()).precipitation(Biome.RainType.NONE).category(Biome.Category.NETHER).depth(0.1F).scale(0.2F).temperature(2.0F).downfall(0.0F).func_235097_a_((new BiomeAmbience.Builder()).setWaterColor(4159204).setWaterFogColor(329011).setFogColor(3343107).func_242539_d(func_244206_a(2.0F)).setParticle(new ParticleEffectAmbience(ParticleTypes.CRIMSON_SPORE, 0.025F)).setAmbientSound(SoundEvents.AMBIENT_CRIMSON_FOREST_LOOP).setMoodSound(new MoodSoundAmbience(SoundEvents.AMBIENT_CRIMSON_FOREST_MOOD, 6000, 8, 2.0D)).setAdditionsSound(new SoundAdditionsAmbience(SoundEvents.AMBIENT_CRIMSON_FOREST_ADDITIONS, 0.0111D)).setMusic(BackgroundMusicTracks.getDefaultBackgroundMusicSelector(SoundEvents.MUSIC_NETHER_CRIMSON_FOREST)).build()).func_242458_a(mobspawninfo).func_242457_a(biomegenerationsettings$builder.func_242508_a()).func_242455_a();
    }

    public static Biome func_244257_w()
    {
        MobSpawnInfo mobspawninfo = (new MobSpawnInfo.Builder()).func_242575_a(EntityClassification.MONSTER, new MobSpawnInfo.Spawners(EntityType.ENDERMAN, 1, 4, 4)).func_242575_a(EntityClassification.CREATURE, new MobSpawnInfo.Spawners(EntityType.STRIDER, 60, 1, 2)).func_242573_a(EntityType.ENDERMAN, 1.0D, 0.12D).func_242577_b();

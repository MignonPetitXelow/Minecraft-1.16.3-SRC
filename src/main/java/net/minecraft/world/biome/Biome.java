...
public final class Biome
{
    ...
    public static final Codec<Supplier<Biome>> field_235051_b_ = RegistryKeyCodec.func_241794_a_(Registry.BIOME_KEY, field_242418_b);
    public static final Codec<List<Supplier<Biome>>> field_242420_e = RegistryKeyCodec.func_244328_b(Registry.BIOME_KEY, field_242418_b);
    ...
    {
        return this.field_235052_p_.getFogColor();
    }
    ...
    {
        return this.field_235052_p_.getWaterColor();
    }

    public final int getWaterFogColor()
    {
        return this.field_235052_p_.getWaterFogColor();
    }

    public Optional<ParticleEffectAmbience> func_235090_t_()
    {
        return this.field_235052_p_.getParticle();
    }

    public Optional<SoundEvent> func_235091_u_()
    {
        return this.field_235052_p_.getAmbientSound();
    }

    public Optional<MoodSoundAmbience> func_235092_v_()
    {
        return this.field_235052_p_.getMoodSound();
    }

    public Optional<SoundAdditionsAmbience> func_235093_w_()
    {
        return this.field_235052_p_.getAdditionsSound();
    }

    public Optional<BackgroundMusicSelector> func_235094_x_()
    {
        return this.field_235052_p_.getMusic();
    }
    ...
    public static enum Category implements IStringSerializable
    {
        ...
        public static final Codec<Biome.Category> field_235102_r_ = IStringSerializable.createEnumCodec(Biome.Category::values, Biome.Category::func_235103_a_);
    ...
    public static enum TemperatureModifier implements IStringSerializable
    {
        ...
        public static final Codec<Biome.TemperatureModifier> field_242473_c = IStringSerializable.createEnumCodec(Biome.TemperatureModifier::values, Biome.TemperatureModifier::func_242477_a);

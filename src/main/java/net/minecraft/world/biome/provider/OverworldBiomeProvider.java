...
public class OverworldBiomeProvider extends BiomeProvider
{
    public static final Codec<OverworldBiomeProvider> field_235297_e_ = RecordCodecBuilder.create((p_235302_0_) ->
    {
        ...
        }), RegistryLookupCodec.func_244331_a(Registry.BIOME_KEY).forGetter((p_242637_0_) -> {
    ...
    {
        return new OverworldBiomeProvider(seed, this.field_235299_i_, this.field_235300_j_, this.field_242636_k);
    }

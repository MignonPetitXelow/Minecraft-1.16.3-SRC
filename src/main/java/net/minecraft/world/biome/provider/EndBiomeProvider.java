...
public class EndBiomeProvider extends BiomeProvider
{
    ...
    {
        return p_242647_0_.group(RegistryLookupCodec.func_244331_a(Registry.BIOME_KEY).forGetter((p_242648_0_) -> {
    ...
    {
        return new EndBiomeProvider(this.field_242640_g, seed, this.field_242641_i, this.field_242642_j, this.field_242643_k, this.field_242644_l, this.field_242645_m);
    }

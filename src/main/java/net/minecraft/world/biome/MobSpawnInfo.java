...
public class MobSpawnInfo
{
    ...
    public static final MapCodec<MobSpawnInfo> field_242552_c = RecordCodecBuilder.mapCodec((p_242561_0_) ->
    {
        ...
        }), Codec.simpleMap(EntityClassification.CODEC, MobSpawnInfo.Spawners.field_242587_b.listOf().promotePartial(Util.func_240982_a_("Spawn data: ", field_242550_a::error)), IStringSerializable.createKeyable(EntityClassification.values())).fieldOf("spawners").forGetter((p_242564_0_) -> {

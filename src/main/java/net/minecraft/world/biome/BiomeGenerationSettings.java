...
public class BiomeGenerationSettings
{
    ...
    public static final MapCodec<BiomeGenerationSettings> field_242481_c = RecordCodecBuilder.mapCodec((p_242495_0_) ->
    {
        ...
        }), Codec.simpleMap(GenerationStage.Carving.field_236074_c_, ConfiguredCarver.field_242759_c.promotePartial(Util.func_240982_a_("Carver: ", field_242479_a::error)), IStringSerializable.createKeyable(GenerationStage.Carving.values())).fieldOf("carvers").forGetter((p_242499_0_) -> {

...
public class ChunkSerializer
{
    ...
    public static ChunkPrimer read(ServerWorld worldIn, TemplateManager templateManagerIn, PointOfInterestManager poiManager, ChunkPos pos, CompoundNBT compound)
    {
        ...
        BiomeContainer biomecontainer = new BiomeContainer(worldIn.func_241828_r().func_243612_b(Registry.BIOME_KEY), pos, biomeprovider, compoundnbt.contains("Biomes", 11) ? compoundnbt.getIntArray("Biomes") : null);
        ...
        boolean flag1 = worldIn.func_230315_m_().hasSkyLight();

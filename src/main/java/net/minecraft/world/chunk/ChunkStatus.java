...
public class ChunkStatus
{
    ...
    public static final ChunkStatus STRUCTURE_STARTS = register("structure_starts", EMPTY, 0, PRE_FEATURES, ChunkStatus.Type.PROTOCHUNK, (p_222586_0_, p_222586_1_, p_222586_2_, p_222586_3_, p_222586_4_, p_222586_5_, p_222586_6_, p_222586_7_) ->
    {
        ...
        {
            if (p_222586_1_.getServer().func_240793_aU_().getDimensionGeneratorSettings().doesGenerateFeatures())
            {
                p_222586_2_.func_242707_a(p_222586_1_.func_241828_r(), p_222586_1_.func_241112_a_(), p_222586_7_, p_222586_3_, p_222586_1_.getSeed());
            }
    ...
    public static final ChunkStatus STRUCTURE_REFERENCES = registerSelective("structure_references", STRUCTURE_STARTS, 8, PRE_FEATURES, ChunkStatus.Type.PROTOCHUNK, (p_222587_0_, p_222587_1_, p_222587_2_, p_222587_3_) ->
    {
        ...
        p_222587_1_.func_235953_a_(worldgenregion, p_222587_0_.func_241112_a_().func_241464_a_(worldgenregion), p_222587_3_);
    });
    ...
    {
        p_222594_1_.func_242706_a(p_222594_0_.func_241828_r().func_243612_b(Registry.BIOME_KEY), p_222594_3_);
    });
    public static final ChunkStatus NOISE = registerSelective("noise", BIOMES, 8, PRE_FEATURES, ChunkStatus.Type.PROTOCHUNK, (p_222592_0_, p_222592_1_, p_222592_2_, p_222592_3_) ->
    {
        ...
        p_222592_1_.func_230352_b_(worldgenregion, p_222592_0_.func_241112_a_().func_241464_a_(worldgenregion), p_222592_3_);
    });
    ...
    {
        p_222590_1_.func_230350_a_(p_222590_0_.getSeed(), p_222590_0_.getBiomeManager(), p_222590_3_, GenerationStage.Carving.AIR);
    });
    ...
    {
        p_222601_1_.func_230350_a_(p_222601_0_.getSeed(), p_222601_0_.getBiomeManager(), p_222601_3_, GenerationStage.Carving.LIQUID);
    });
    ...
    {
        p_222602_1_.func_230354_a_(new WorldGenRegion(p_222602_0_, p_222602_2_));
    });

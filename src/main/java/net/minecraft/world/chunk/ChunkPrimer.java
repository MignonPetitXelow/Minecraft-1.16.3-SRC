...
public class ChunkPrimer implements IChunk
{
    ...
    public ChunkPrimer(ChunkPos p_i49941_1_, UpgradeData upgradeData, @Nullable ChunkSection[] sections, ChunkPrimerTickList<Block> pendingBlockTicks, ChunkPrimerTickList<Fluid> pendingFluidTicks)
    {

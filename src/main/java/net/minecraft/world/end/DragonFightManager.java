...
public class DragonFightManager
{
    ...
    {
        this.world = p_i231901_1_;

        if (p_i231901_4_.contains("DragonKilled", 99))
        {
            if (p_i231901_4_.hasUniqueId("Dragon"))
            {
                this.dragonUniqueId = p_i231901_4_.getUniqueId("Dragon");
            }
            ...
            {
                this.exitPortalLocation = NBTUtil.readBlockPos(p_i231901_4_.getCompound("ExitPortalLocation"));
            }
        }
        else
        {
    ...
    private void generateGateway(BlockPos pos)
    {
        ...
        Features.field_243907_c.func_242765_a(this.world, this.world.getChunkProvider().getChunkGenerator(), new Random(), pos);
    }

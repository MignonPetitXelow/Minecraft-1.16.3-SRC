...
public class RaidManager extends WorldSavedData
{
    ...
    {
        super(func_234620_a_(p_i50142_1_.func_230315_m_()));
    ...
    public static boolean canJoinRaid(AbstractRaiderEntity p_215165_0_, Raid p_215165_1_)
    {
        ...
        {
            return p_215165_0_.isAlive() && p_215165_0_.func_213658_ej() && p_215165_0_.getIdleTime() <= 2400 && p_215165_0_.world.func_230315_m_() == p_215165_1_.getWorld().func_230315_m_();
        }
        else
        {
            return false;

...
public class GameRules
{
    ...
    public static final GameRules.RuleKey<GameRules.BooleanValue> DO_PATROL_SPAWNING = func_234903_a_("doPatrolSpawning", GameRules.Category.SPAWNING, GameRules.BooleanValue.create(true));
    public static final GameRules.RuleKey<GameRules.BooleanValue> DO_TRADER_SPAWNING = func_234903_a_("doTraderSpawning", GameRules.Category.SPAWNING, GameRules.BooleanValue.create(true));
    public static final GameRules.RuleKey<GameRules.BooleanValue> FORGIVE_DEAD_PLAYERS = func_234903_a_("forgiveDeadPlayers", GameRules.Category.MOBS, GameRules.BooleanValue.create(true));
    public static final GameRules.RuleKey<GameRules.BooleanValue> UNIVERSAL_ANGER = func_234903_a_("universalAnger", GameRules.Category.MOBS, GameRules.BooleanValue.create(false));
    private final Map < GameRules.RuleKey<?>, GameRules.RuleValue<? >> rules;

    private static <T extends GameRules.RuleValue<T>> GameRules.RuleKey<T> func_234903_a_(String p_234903_0_, GameRules.Category p_234903_1_, GameRules.RuleType<T> p_234903_2_)
    {
    ...
    {
        p_234897_0_.visit((RuleKey)p_234897_1_, p_234897_2_);
        p_234897_2_.func_234914_a_(p_234897_0_, (RuleKey) p_234897_1_);
    }

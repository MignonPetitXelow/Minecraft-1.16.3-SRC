        ...
        while (true)
        {
            ...
            if (entityclassification != EntityClassification.MISC)
            {
                ...
                p_234964_2_.query(i, (p_234971_5_) ->
                {
                    ...
                    {
                        mobdensitytracker.func_234998_a_(entity_f.getPosition(), mobspawninfo$spawncosts.func_242585_b());
                    }
                ...
                for (int l1 = 0; l1 < k; ++l1)
                {
                    ...
                    for (int i2 = 0; !flag && i2 < 4; ++i2)
                    {
                        ...
                        if (mobspawninfo$spawners.field_242588_c.isSummonable() && canCreatureTypeSpawnAtLocation(EntitySpawnPlacementRegistry.getPlacementType(mobspawninfo$spawners.field_242588_c), worldIn, blockpos, mobspawninfo$spawners.field_242588_c))
                        {
                            ...
                            if (!worldIn.hasNoCollisions(mobspawninfo$spawners.field_242588_c.getBoundingBoxWithSizeApplied(d0, (double)blockpos.getY(), d1)) || !EntitySpawnPlacementRegistry.canSpawnEntity(mobspawninfo$spawners.field_242588_c, worldIn, SpawnReason.CHUNK_GENERATION, new BlockPos(d0, (double)blockpos.getY(), d1), worldIn.getRandom()))
                            {
                                continue;
                            }

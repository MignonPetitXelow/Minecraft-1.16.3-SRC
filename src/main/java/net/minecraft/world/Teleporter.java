...
public class Teleporter
{
    ...
    public Optional<TeleportationRepositioner.Result> func_242957_a(BlockPos p_242957_1_, boolean p_242957_2_)
    {
        ...
        {
            return this.world.getBlockState(p_242958_1_.getPos()).hasProperty(BlockStateProperties.HORIZONTAL_AXIS);
        }).findFirst();
    ...
    public Optional<TeleportationRepositioner.Result> func_242956_a(BlockPos p_242956_1_, Direction.Axis p_242956_2_)
    {
        ...
        BlockPos.Mutable blockpos$mutable = p_242956_1_.toMutable();
    ...
    private boolean func_242955_a(BlockPos p_242955_1_, BlockPos.Mutable p_242955_2_, Direction p_242955_3_, int p_242955_4_)
    {
        ...
        for (int i = -1; i < 3; ++i)
        {
            for (int j = -1; j < 4; ++j)
            {
                p_242955_2_.setAndOffset(p_242955_1_, p_242955_3_.getXOffset() * i + direction.getXOffset() * p_242955_4_, j, p_242955_3_.getZOffset() * i + direction.getZOffset() * p_242955_4_);

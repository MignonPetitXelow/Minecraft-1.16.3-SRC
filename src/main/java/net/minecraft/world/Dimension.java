...
public final class Dimension
{
    ...
    public static boolean func_236060_a_(long p_236060_0_, SimpleRegistry<Dimension> p_236060_2_)
    {
        ...
        else
        {
            ...
            {
                if (!entry.getValue().getDimensionType().func_242714_a(DimensionType.OVERWORLD_TYPE) && entry.getValue().getDimensionType() != DimensionType.field_241498_j_)
                {
                    return false;
                }
                else if (!entry1.getValue().getDimensionType().func_242714_a(DimensionType.NETHER_TYPE))
                {
                    return false;
                }
                else if (!entry2.getValue().getDimensionType().func_242714_a(DimensionType.END_TYPE))
                {
                    return false;
                }
                else if (entry1.getValue().getChunkGenerator() instanceof NoiseChunkGenerator && entry2.getValue().getChunkGenerator() instanceof NoiseChunkGenerator)
                {
                    ...
                    else
                    {
                        ...
                        else
                        {
                            ...
                            return endbiomeprovider.areProvidersEqual(p_236060_0_);
                        }
                    }
                }
                else

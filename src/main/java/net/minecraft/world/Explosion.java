                ...
                for (int l = 0; l < 16; ++l)
                {
                    if (j == 0 || j == 15 || k == 0 || k == 15 || l == 0 || l == 15)
                    {
                        ...
                        for (float f1 = 0.3F; f > 0.0F; f -= 0.22500001F)
                        {
                            ...
                            Optional<Float> optional = this.field_234893_k_.getExplosionResistance(this, this.world, blockpos, blockstate, fluidstate);
                            ...
                            if (f > 0.0F && this.field_234893_k_.canExplosionDestroyBlock(this, this.world, blockpos, blockstate, f))
                            {
                                set.add(blockpos);
                            }

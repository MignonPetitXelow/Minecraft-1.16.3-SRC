...
{
    public static final Codec<AlterGroundTreeDecorator> field_236859_a_ = BlockStateProvider.field_236796_a_.fieldOf("provider").xmap(AlterGroundTreeDecorator::new, (p_236862_0_) ->
    {
    ...
    private void func_227414_b_(IWorldGenerationReader p_227414_1_, Random p_227414_2_, BlockPos p_227414_3_)
    {
        for (int i = 2; i >= -3; --i)
        {
            ...
            if (Feature.func_236293_a_(p_227414_1_, blockpos))
            {
                p_227414_1_.setBlockState(blockpos, this.field_227410_b_.getBlockState(p_227414_2_, p_227414_3_), 19);
                break;
            }

            if (!Feature.func_236297_b_(p_227414_1_, blockpos) && i < 0)
            {
                break;
            }
        }

...
{
    public static final Codec<DebugChunkGenerator> field_236066_e_ = RegistryLookupCodec.func_244331_a(Registry.BIOME_KEY).xmap(DebugChunkGenerator::new, DebugChunkGenerator::func_242727_g).stable().codec();
    ...
    {
        super(new SingleBiomeProvider(p_i241974_1_.func_243576_d(Biomes.PLAINS)), new DimensionStructuresSettings(false));

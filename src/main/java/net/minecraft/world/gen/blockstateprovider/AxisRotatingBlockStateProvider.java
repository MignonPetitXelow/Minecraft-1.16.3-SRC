...
{
    public static final Codec<AxisRotatingBlockStateProvider> field_236807_b_ = BlockState.CODEC.fieldOf("state").xmap(AbstractBlock.AbstractBlockState::getBlock, Block::getDefaultState).xmap(AxisRotatingBlockStateProvider::new, (p_236808_0_) ->
    {

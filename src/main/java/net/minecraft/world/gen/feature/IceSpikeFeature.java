                ...
                for (int i1 = -l; i1 <= l; ++i1)
                {
                    ...
                    for (int j1 = -l; j1 <= l; ++j1)
                    {
                        ...
                        if ((i1 == 0 && j1 == 0 || !(f1 * f1 + f2 * f2 > f * f)) && (i1 != -l && i1 != l && j1 != -l && j1 != l || !(p_241855_3_.nextFloat() > 0.75F)))
                        {
                            ...
                            {
                                this.func_230367_a_(p_241855_1_, p_241855_4_.add(i1, k, j1), Blocks.PACKED_ICE.getDefaultState());
                            }
            ...
            for (int l1 = -k1; l1 <= k1; ++l1)
            {
                for (int i2 = -k1; i2 <= k1; ++i2)
                {
                    ...
                    while (blockpos.getY() > 50)
                    {
                        ...
                        this.func_230367_a_(p_241855_1_, blockpos, Blocks.PACKED_ICE.getDefaultState());

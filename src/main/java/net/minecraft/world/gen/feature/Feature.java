...
public abstract class Feature<FC extends IFeatureConfig>
{
    ...
    public static final Feature<BaseTreeFeatureConfig> field_236291_c_ = register("tree", new TreeFeature(BaseTreeFeatureConfig.CODEC));
    ...
    public static final Feature<ColumnConfig> field_236285_P_ = register("basalt_columns", new BasaltColumnFeature(ColumnConfig.CODEC));

...
public class BigMushroomFeatureConfig implements IFeatureConfig
{
    ...
    {
        return p_236530_0_.group(BlockStateProvider.field_236796_a_.fieldOf("cap_provider").forGetter((p_236532_0_) -> {
            return p_236532_0_.field_227272_a_;
        }), BlockStateProvider.field_236796_a_.fieldOf("stem_provider").forGetter((p_236531_0_) -> {

...
{
    public static final Codec<BlockStateProvidingFeatureConfig> field_236453_a_ = BlockStateProvider.field_236796_a_.fieldOf("state_provider").xmap(BlockStateProvidingFeatureConfig::new, (p_236454_0_) ->
    {

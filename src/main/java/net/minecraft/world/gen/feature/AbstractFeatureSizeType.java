...
{
    public static final Codec<AbstractFeatureSizeType> field_236704_a_ = Registry.FEATURE_SIZE_TYPE.dispatch(AbstractFeatureSizeType::func_230370_b_, FeatureSizeType::func_236714_a_);

...
public class ConfiguredFeature<FC extends IFeatureConfig, F extends Feature<FC>> implements IDecoratable < ConfiguredFeature <? , ? >>
{
    ...
    }, Feature::func_236292_a_);
    public static final Codec < Supplier < ConfiguredFeature <? , ? >>> field_236264_b_ = RegistryKeyCodec.func_241794_a_(Registry.field_243552_au, field_242763_a);
    public static final Codec < List < Supplier < ConfiguredFeature <? , ? >>> > field_242764_c = RegistryKeyCodec.func_244328_b(Registry.field_243552_au, field_242763_a);

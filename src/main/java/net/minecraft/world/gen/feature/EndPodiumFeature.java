...
public class EndPodiumFeature extends Feature<NoFeatureConfig>
{
    ...
    public boolean func_241855_a(ISeedReader p_241855_1_, ChunkGenerator p_241855_2_, Random p_241855_3_, BlockPos p_241855_4_, NoFeatureConfig p_241855_5_)
    {
        for (BlockPos blockpos : BlockPos.getAllInBoxMutable(new BlockPos(p_241855_4_.getX() - 4, p_241855_4_.getY() - 1, p_241855_4_.getZ() - 4), new BlockPos(p_241855_4_.getX() + 4, p_241855_4_.getY() + 32, p_241855_4_.getZ() + 4)))
        {
            ...
            if (flag || blockpos.withinDistance(p_241855_4_, 3.5D))
            {
                if (blockpos.getY() < p_241855_4_.getY())
                {
                    if (flag)
                    {
                        this.func_230367_a_(p_241855_1_, blockpos, Blocks.BEDROCK.getDefaultState());
                    }
                    else if (blockpos.getY() < p_241855_4_.getY())
                    {
                        this.func_230367_a_(p_241855_1_, blockpos, Blocks.END_STONE.getDefaultState());
                    }
                }
                else if (blockpos.getY() > p_241855_4_.getY())
                {
                    this.func_230367_a_(p_241855_1_, blockpos, Blocks.AIR.getDefaultState());
                }
                else if (!flag)
                {
                    this.func_230367_a_(p_241855_1_, blockpos, Blocks.BEDROCK.getDefaultState());
                ...
                {
                    this.func_230367_a_(p_241855_1_, new BlockPos(blockpos), Blocks.END_PORTAL.getDefaultState());
                }
                else
                {
                    this.func_230367_a_(p_241855_1_, new BlockPos(blockpos), Blocks.AIR.getDefaultState());
                }
            }
        }
        ...
        for (int i = 0; i < 4; ++i)
        {
            this.func_230367_a_(p_241855_1_, p_241855_4_.up(i), Blocks.BEDROCK.getDefaultState());
        }
        ...
        {
            this.func_230367_a_(p_241855_1_, blockpos1.offset(direction), Blocks.WALL_TORCH.getDefaultState().with(WallTorchBlock.HORIZONTAL_FACING, direction));
        }

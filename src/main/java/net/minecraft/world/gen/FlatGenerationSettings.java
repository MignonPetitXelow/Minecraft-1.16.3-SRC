...
public class FlatGenerationSettings
{
    ...
    {
        return p_236938_0_.group(RegistryLookupCodec.func_244331_a(Registry.BIOME_KEY).forGetter((p_242874_0_) -> {
        ...
        }), Biome.field_235051_b_.optionalFieldOf("biome").orElseGet(Optional::empty).forGetter((p_242868_0_) -> {
    ...
    public FlatGenerationSettings(Registry<Biome> p_i242012_1_, DimensionStructuresSettings p_i242012_2_, List<FlatLayerInfo> p_i242012_3_, boolean p_i242012_4_, boolean p_i242012_5_, Optional<Supplier<Biome>> p_i242012_6_)
    {
        ...
        if (!p_i242012_6_.isPresent())
        {
            ...
            this.biomeToUse = () ->
            {
                return p_i242012_1_.func_243576_d(Biomes.PLAINS);
            };
        }
        else
        {
    ...
    public FlatGenerationSettings(DimensionStructuresSettings p_i242011_1_, Registry<Biome> p_i242011_2_)
    {
        ...
        this.biomeToUse = () ->
        {
            return p_i242011_2_.func_243576_d(Biomes.PLAINS);
        };
    }
    ...
    public Biome func_236942_c_()
    {
        ...
        {
            biomegenerationsettings$builder.func_242516_a(biomegenerationsettings.func_242491_a(STRUCTURES.get(entry.getKey())));
        }

        boolean flag = (!this.allAir || this.field_242867_d.func_230519_c_(biome).equals(Optional.of(Biomes.THE_VOID))) && this.field_236934_k_;
        ...
        for (int j = 0; j < ablockstate.length; ++j)
        {
            ...
            {
                this.states[j] = null;
                biomegenerationsettings$builder.func_242513_a(GenerationStage.Decoration.TOP_LAYER_MODIFICATION, Feature.FILL_LAYER.withConfiguration(new FillLayerConfig(j, blockstate)));
            }
        }

        return (new Biome.Builder()).precipitation(biome.getPrecipitation()).category(biome.getCategory()).depth(biome.getDepth()).scale(biome.getScale()).temperature(biome.func_242445_k()).downfall(biome.getDownfall()).func_235097_a_(biome.func_235089_q_()).func_242457_a(biomegenerationsettings$builder.func_242508_a()).func_242458_a(biome.func_242433_b()).func_242455_a();
    }
    ...
    public static FlatGenerationSettings func_242869_a(Registry<Biome> p_242869_0_)
    {
        ...
        {
            return p_242869_0_.func_243576_d(Biomes.PLAINS);
        };

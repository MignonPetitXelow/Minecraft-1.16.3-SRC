...
public class DimensionGeneratorSettings
{
    ...
    {
        Registry<Biome> registry = p_242752_0_.func_243612_b(Registry.BIOME_KEY);
        int i = "North Carolina".hashCode();
        Registry<DimensionType> registry1 = p_242752_0_.func_243612_b(Registry.DIMENSION_TYPE_KEY);
    ...
    public static SimpleRegistry<Dimension> func_242749_a(Registry<DimensionType> p_242749_0_, SimpleRegistry<Dimension> p_242749_1_, ChunkGenerator p_242749_2_)
    {
        ...
        {
            return dimension == null ? p_242749_0_.func_243576_d(DimensionType.OVERWORLD) : dimension.getDimensionType();
        };
    ...
    public static DimensionGeneratorSettings func_242753_a(DynamicRegistries p_242753_0_, Properties p_242753_1_)
    {
        ...
        Registry<DimensionType> registry2 = p_242753_0_.func_243612_b(Registry.DIMENSION_TYPE_KEY);
        Registry<Biome> registry = p_242753_0_.func_243612_b(Registry.BIOME_KEY);
    ...
    public DimensionGeneratorSettings create(boolean hardcore, OptionalLong worldSeed)
    {
        ...
        if (worldSeed.isPresent())
        {
            ...
            {
                RegistryKey<Dimension> registrykey = entry.getKey();
                simpleregistry.register(registrykey, new Dimension(entry.getValue().getDimensionTypeSupplier(), entry.getValue().getChunkGenerator().func_230349_a_(j)), this.field_236208_h_.func_241876_d(entry.getValue()));
            }
        }
        else
        {

...
public class TagRegistry<T>
{
    ...
    public Set<ResourceLocation> func_242189_b(ITagCollectionSupplier p_242189_1_)
    {
        ...
        Set<ResourceLocation> set = this.field_232931_c_.stream().map(TagRegistry.NamedTag::getName).collect(Collectors.toSet());
    ...
    static class NamedTag<T> implements ITag.INamedTag<T>
    {
        ...
        {
            return this.func_232944_c_().contains(element);
        }

        public List<T> getAllElements()
        {
            return this.func_232944_c_().getAllElements();
        }
    }
}

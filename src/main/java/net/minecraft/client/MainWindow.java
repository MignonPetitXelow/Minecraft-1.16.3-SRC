...
public final class MainWindow implements AutoCloseable
{
    ...
    public MainWindow(IWindowEventListener p_i51170_1_, MonitorHandler p_i51170_2_, ScreenSize p_i51170_3_, @Nullable String videoModeName, String titleIn)
    {
        ...
        if (Reflector.EarlyProgressVisualization_handOffWindow.exists())
        {
            ...
            this.handle = Reflector.callLong(object, Reflector.EarlyProgressVisualization_handOffWindow, (IntSupplier)() ->
            {
                return this.width;
            }, (IntSupplier)() ->
            {
        ...
        GLFW.glfwSetCursorEnterCallback(this.handle, this::func_241553_b_);
    }
    ...
    private void func_241553_b_(long p_241553_1_, boolean p_241553_3_)
    {
        if (p_241553_3_)
        {
            this.mc.func_241216_b_();
        }
    }

...
public class ClientLoginNetHandler implements IClientLoginNetHandler
{
    ...
    public void onDisconnect(ITextComponent reason)
    {
        ...
        {
            this.mc.displayGuiScreen(new DisconnectedRealmsScreen(this.previousGuiScreen, DialogTexts.field_244280_i, reason));
        }
        else
        {
            this.mc.displayGuiScreen(new DisconnectedScreen(this.previousGuiScreen, DialogTexts.field_244280_i, reason));
        }
    }

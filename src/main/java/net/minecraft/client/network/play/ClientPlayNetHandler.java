...
public class ClientPlayNetHandler implements IClientPlayNetHandler
{
    ...
    private ITagCollectionSupplier networkTagManager = ITagCollectionSupplier.field_242208_a;
    ...
    public void handleChunkData(SChunkDataPacket packetIn)
    {
        ...
        BiomeContainer biomecontainer = packetIn.func_244296_i() == null ? null : new BiomeContainer(this.field_239163_t_.func_243612_b(Registry.BIOME_KEY), packetIn.func_244296_i());

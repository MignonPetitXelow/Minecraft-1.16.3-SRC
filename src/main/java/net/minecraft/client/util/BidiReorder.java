...
public class BidiReorder
{
        ...
        else
        {
            ...
            for (int j = 1; j < p_244287_2_; ++j)
            {
                ...
                if (!style1.equals(style))
                {
                    ...
                    list.add(p_244287_3_ ? IReorderingProcessor.func_242246_b(s, style, this.field_244285_c) : IReorderingProcessor.func_242239_a(s, style));
                    style = style1;
                    i = k;
                }
            }
            ...
            if (i < p_244287_1_ + p_244287_2_)
            {
                ...
                list.add(p_244287_3_ ? IReorderingProcessor.func_242246_b(s1, style, this.field_244285_c) : IReorderingProcessor.func_242239_a(s1, style));
            }
    ...
    public static BidiReorder func_244290_a(ITextProperties p_244290_0_, Int2IntFunction p_244290_1_, UnaryOperator<String> p_244290_2_)
    {
        ...
        p_244290_0_.func_230439_a_((p_244289_2_, p_244289_3_) ->
        {

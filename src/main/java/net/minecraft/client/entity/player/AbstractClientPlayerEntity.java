...
public abstract class AbstractClientPlayerEntity extends PlayerEntity
{
    ...
    public float getFovModifier()
    {
        ...
        return Reflector.ForgeHooksClient_getOffsetFOV.exists() ? Reflector.callFloat(Reflector.ForgeHooksClient_getOffsetFOV, this, f) : MathHelper.lerp(Minecraft.getInstance().gameSettings.field_243227_aN, 1.0F, f);
    }

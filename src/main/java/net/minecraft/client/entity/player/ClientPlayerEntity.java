...
public class ClientPlayerEntity extends AbstractClientPlayerEntity
{
    ...
    {
        BlockPos blockpos = new BlockPos(p_244389_1_, this.getPosY(), p_244389_3_);
    ...
    private boolean shouldBlockPushPlayer(BlockPos pos)
    {
        ...
        return !this.world.func_242405_a(this, axisalignedbb1, (p_243494_1_, p_243494_2_) ->
        {
            return p_243494_1_.isSuffocating(this.world, p_243494_2_);
        });
    }
    ...
    public void livingTick()
    {
        ...
        this.movementInput.tickMovement(this.func_228354_I_());
        ...
        if (!this.noClip)
        {
            this.func_244389_i(this.getPosX() - (double)this.getWidth() * 0.35D, this.getPosZ() + (double)this.getWidth() * 0.35D);
            this.func_244389_i(this.getPosX() - (double)this.getWidth() * 0.35D, this.getPosZ() - (double)this.getWidth() * 0.35D);
            this.func_244389_i(this.getPosX() + (double)this.getWidth() * 0.35D, this.getPosZ() - (double)this.getWidth() * 0.35D);
            this.func_244389_i(this.getPosX() + (double)this.getWidth() * 0.35D, this.getPosZ() + (double)this.getWidth() * 0.35D);
        }
    ...
    {
        if (this.mc.gameSettings.func_243230_g().func_243192_a())
        {
            float f = MathHelper.lerp(p_241843_1_ * 0.5F, this.rotationYaw, this.prevRotationYaw) * ((float)Math.PI / 180F);
            float f1 = MathHelper.lerp(p_241843_1_ * 0.5F, this.rotationPitch, this.prevRotationPitch) * ((float)Math.PI / 180F);
            double d0 = this.getPrimaryHand() == HandSide.RIGHT ? -1.0D : 1.0D;
            Vector3d vector3d = new Vector3d(0.39D * d0, -0.6D, 0.3D);
            return vector3d.rotatePitch(-f1).rotateYaw(-f).add(this.getEyePosition(p_241843_1_));
        }
        else
        {

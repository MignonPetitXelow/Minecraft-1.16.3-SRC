...
public interface IBidiRenderer
{
    ...
    {
        return func_243262_b(p_243258_0_, p_243258_0_.func_238425_b_(p_243258_1_, p_243258_2_).stream().map((p_243264_1_) ->
        {
    ...
    {
        return func_243262_b(p_243259_0_, p_243259_0_.func_238425_b_(p_243259_1_, p_243259_2_).stream().limit((long)p_243259_3_).map((p_243263_1_) ->
        {

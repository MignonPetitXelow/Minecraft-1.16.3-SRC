    ...
    public void render(MatrixStack p_195620_1_)
    {
        ...
        if (this.enabled && !this.subtitles.isEmpty())
        {
            ...
            while (iterator.hasNext())
            {
                ...
                {
                    j = Math.max(j, this.client.fontRenderer.func_238414_a_(subtitleoverlaygui$subtitle.func_238526_a_()));
                }
            }
            ...
            for (SubtitleOverlayGui.Subtitle subtitleoverlaygui$subtitle1 : this.subtitles)
            {
                ...
                int j1 = i1 / 2;
                float f = 1.0F;
                int k1 = this.client.fontRenderer.func_238414_a_(itextcomponent);

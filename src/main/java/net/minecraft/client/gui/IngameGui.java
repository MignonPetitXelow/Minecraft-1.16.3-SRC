...
public class IngameGui extends AbstractGui
{
    ...
    private void func_238456_d_(MatrixStack p_238456_1_)
    {
        ...
        if (gamesettings.func_243230_g().func_243192_a() && (this.mc.playerController.getCurrentGameType() != GameType.SPECTATOR || this.isTargetNamedMenuProvider(this.mc.objectMouseOver)))
        {
    ...
    public void func_238453_b_(MatrixStack p_238453_1_)
    {
        ...
        if (this.remainingHighlightTicks > 0 && !this.highlightingItemStack.isEmpty())
        {
            ...
            if (l > 0)
            {
                ...
                {
                    i = (this.scaledWidth - fontrenderer.func_238414_a_(itextcomponent)) / 2;

...
public class FontRenderer
{
    ...
    public FontRenderer(Function<ResourceLocation, Font> p_i232249_1_)
    {
        ...
        {
            return this.func_238419_a_(p_lambda$new$0_2_.getFontId()).func_238557_a_(p_lambda$new$0_1_).getAdvance(p_lambda$new$0_2_.getBold());
        });
    }
    ...
    public int drawString(MatrixStack p_238421_1_, String p_238421_2_, float p_238421_3_, float p_238421_4_, int p_238421_5_)
    {
        RenderSystem.enableAlphaTest();
    ...
    {
        return this.field_238402_e_.func_238358_a_(p_238417_1_, p_238417_2_, Style.EMPTY);
    }
    ...
    class CharacterRenderer implements ICharacterConsumer
    {
        ...
        public float func_238441_a_(int p_238441_1_, float p_238441_2_)
        {
            ...
            if (this.field_238440_n_ != null)
            {
                TexturedGlyph texturedglyph = FontRenderer.this.func_238419_a_(Style.DEFAULT_FONT).getWhiteGlyph();
                IVertexBuilder ivertexbuilder = this.field_238427_a_.getBuffer(texturedglyph.getRenderType(this.field_238436_j_));
        ...
        private Font getFont(Style p_getFont_1_)
        {
            ...
            else
            {
                ...
                this.lastStyleFont = FontRenderer.this.func_238419_a_(p_getFont_1_.getFontId());
                return this.lastStyleFont;
            }
        }
    }

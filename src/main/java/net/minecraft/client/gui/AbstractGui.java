...
public abstract class AbstractGui
{
    ...
    public static void drawCenteredString(MatrixStack p_238471_0_, FontRenderer matrixStack, String font, int text, int x, int y)
    {
        matrixStack.drawStringWithShadow(p_238471_0_, font, (float)(text - matrixStack.getStringWidth(font) / 2), (float)x, y);
    }

    public static void drawCenteredString(MatrixStack p_238472_0_, FontRenderer matrixStack, ITextComponent font, int text, int x, int y)
    {
        IReorderingProcessor ireorderingprocessor = font.func_241878_f();
        matrixStack.func_238407_a_(p_238472_0_, ireorderingprocessor, (float)(text - matrixStack.func_243245_a(ireorderingprocessor) / 2), (float)x, y);
    }

    public static void drawString(MatrixStack p_238476_0_, FontRenderer matrixStack, String font, int text, int x, int y)
    {
        matrixStack.drawStringWithShadow(p_238476_0_, font, (float)text, (float)x, y);
    }

    public static void drawString(MatrixStack p_238475_0_, FontRenderer matrixStack, ITextComponent font, int text, int x, int y)
    {
        matrixStack.func_243246_a(p_238475_0_, font, (float)text, (float)x, y);
    }

...
public class FlatPresetsScreen extends Screen
{
            ...
            else
            {
                ...
                if (iterator.hasNext())
                {
                    try
                    {
                        ...
                        registrykey = RegistryKey.func_240903_a_(Registry.BIOME_KEY, resourcelocation);
    ...
    protected void init()
    {
        ...
        Registry<Biome> registry = this.parentScreen.createWorldGui.field_238934_c_.func_239055_b_().func_243612_b(Registry.BIOME_KEY);
    ...
    class SlotList extends ExtendedList<FlatPresetsScreen.SlotList.PresetEntry>
    {
        ...
        public class PresetEntry extends ExtendedList.AbstractListEntry<FlatPresetsScreen.SlotList.PresetEntry>
        {
            ...
            private void func_214399_a()
            {
                ...
                Registry<Biome> registry = FlatPresetsScreen.this.parentScreen.createWorldGui.field_238934_c_.func_239055_b_().func_243612_b(Registry.BIOME_KEY);

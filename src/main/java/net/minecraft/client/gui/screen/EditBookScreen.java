...
public class EditBookScreen extends Screen
{
    ...
    private static final IReorderingProcessor field_243342_c = IReorderingProcessor.func_242239_a("_", Style.EMPTY.setFormatting(TextFormatting.BLACK));
    private static final IReorderingProcessor field_243343_p = IReorderingProcessor.func_242239_a("_", Style.EMPTY.setFormatting(TextFormatting.GRAY));
    ...
    public void render(MatrixStack matrixStack, int mouseX, int mouseY, float partialTicks)
    {
        ...
        if (this.bookGettingSigned)
        {
            ...
            IReorderingProcessor ireorderingprocessor = IReorderingProcessor.func_242234_a(IReorderingProcessor.func_242239_a(this.bookTitle, Style.EMPTY), flag ? field_243342_c : field_243343_p);
            int k = this.font.func_238414_a_(field_243340_a);
            ...
            int i1 = this.font.func_238414_a_(this.field_243339_L);
        ...
        {
            int j1 = this.font.func_238414_a_(this.field_243338_K);

...
public abstract class BiomeGeneratorTypeScreens
{
    public static final BiomeGeneratorTypeScreens field_239066_a_ = new BiomeGeneratorTypeScreens("default")
    {
        protected ChunkGenerator func_241869_a(Registry<Biome> p_241869_1_, Registry<DimensionSettings> p_241869_2_, long p_241869_3_)
        {
            ...
            {
                return p_241869_2_.func_243576_d(DimensionSettings.field_242734_c);
            });
        }
    };
    ...
    public static final BiomeGeneratorTypeScreens field_239067_b_ = new BiomeGeneratorTypeScreens("amplified")
    {
        protected ChunkGenerator func_241869_a(Registry<Biome> p_241869_1_, Registry<DimensionSettings> p_241869_2_, long p_241869_3_)
        {
            return new NoiseChunkGenerator(new OverworldBiomeProvider(p_241869_3_, false, false, p_241869_1_), p_241869_3_, () ->
            {
                return p_241869_2_.func_243576_d(DimensionSettings.field_242735_d);
            });
        }
    };
    private static final BiomeGeneratorTypeScreens field_239072_g_ = new BiomeGeneratorTypeScreens("single_biome_surface")
    {
        protected ChunkGenerator func_241869_a(Registry<Biome> p_241869_1_, Registry<DimensionSettings> p_241869_2_, long p_241869_3_)
        {
            return new NoiseChunkGenerator(new SingleBiomeProvider(p_241869_1_.func_243576_d(Biomes.PLAINS)), p_241869_3_, () ->
            {
                return p_241869_2_.func_243576_d(DimensionSettings.field_242734_c);
            });
        }
    ...
    private static final BiomeGeneratorTypeScreens field_239073_h_ = new BiomeGeneratorTypeScreens("single_biome_caves")
    {
        ...
        {
            Registry<Biome> registry = p_241220_1_.func_243612_b(Registry.BIOME_KEY);
            Registry<DimensionType> registry1 = p_241220_1_.func_243612_b(Registry.DIMENSION_TYPE_KEY);
            Registry<DimensionSettings> registry2 = p_241220_1_.func_243612_b(Registry.field_243549_ar);
            return new DimensionGeneratorSettings(p_241220_2_, p_241220_4_, p_241220_5_, DimensionGeneratorSettings.func_241520_a_(DimensionType.func_242718_a(registry1, registry, registry2, p_241220_2_), () ->
            {
                return registry1.func_243576_d(DimensionType.field_241497_i_);
        ...
        protected ChunkGenerator func_241869_a(Registry<Biome> p_241869_1_, Registry<DimensionSettings> p_241869_2_, long p_241869_3_)
        {
            return new NoiseChunkGenerator(new SingleBiomeProvider(p_241869_1_.func_243576_d(Biomes.PLAINS)), p_241869_3_, () ->
            {
                return p_241869_2_.func_243576_d(DimensionSettings.field_242738_g);
            });
        }
    };
    private static final BiomeGeneratorTypeScreens field_239074_i_ = new BiomeGeneratorTypeScreens("single_biome_floating_islands")
    {
        protected ChunkGenerator func_241869_a(Registry<Biome> p_241869_1_, Registry<DimensionSettings> p_241869_2_, long p_241869_3_)
        {
            return new NoiseChunkGenerator(new SingleBiomeProvider(p_241869_1_.func_243576_d(Biomes.PLAINS)), p_241869_3_, () ->
            {
                return p_241869_2_.func_243576_d(DimensionSettings.field_242739_h);
            });
        }
    };
    ...
    protected static final Map<Optional<BiomeGeneratorTypeScreens>, BiomeGeneratorTypeScreens.IFactory> field_239069_d_ = ImmutableMap.of(Optional.of(field_239070_e_), (p_239089_0_, p_239089_1_) ->
    {
        ...
        return new CreateFlatWorldScreen(p_239089_0_, (p_239083_2_) -> {
            p_239089_0_.field_238934_c_.func_239043_a_(new DimensionGeneratorSettings(p_239089_1_.getSeed(), p_239089_1_.doesGenerateFeatures(), p_239089_1_.hasBonusChest(), DimensionGeneratorSettings.func_242749_a(p_239089_0_.field_238934_c_.func_239055_b_().func_243612_b(Registry.DIMENSION_TYPE_KEY), p_239089_1_.func_236224_e_(), new FlatChunkGenerator(p_239083_2_))));
        }, chunkgenerator instanceof FlatChunkGenerator ? ((FlatChunkGenerator)chunkgenerator).func_236073_g_() : FlatGenerationSettings.func_242869_a(p_239089_0_.field_238934_c_.func_239055_b_().func_243612_b(Registry.BIOME_KEY)));
    ...
    private static DimensionGeneratorSettings func_243452_a(DynamicRegistries p_243452_0_, DimensionGeneratorSettings p_243452_1_, BiomeGeneratorTypeScreens p_243452_2_, Biome p_243452_3_)
    {
        ...
        Registry<DimensionType> registry = p_243452_0_.func_243612_b(Registry.DIMENSION_TYPE_KEY);
        Registry<DimensionSettings> registry1 = p_243452_0_.func_243612_b(Registry.field_243549_ar);
        ...
        if (p_243452_2_ == field_239073_h_)
        {
            supplier = () ->
            {
                return registry1.func_243576_d(DimensionSettings.field_242738_g);
            };
        }
        else if (p_243452_2_ == field_239074_i_)
        {
            supplier = () ->
            {
                return registry1.func_243576_d(DimensionSettings.field_242739_h);
            };
        }
        else
        {
    ...
    {
        return p_243451_1_.func_236225_f_().getBiomeProvider().getBiomes().stream().findFirst().orElse(p_243451_0_.func_243612_b(Registry.BIOME_KEY).func_243576_d(Biomes.PLAINS));
    }
    ...
    public DimensionGeneratorSettings func_241220_a_(DynamicRegistries.Impl p_241220_1_, long p_241220_2_, boolean p_241220_4_, boolean p_241220_5_)
    {
        ...
        Registry<DimensionType> registry1 = p_241220_1_.func_243612_b(Registry.DIMENSION_TYPE_KEY);
        Registry<DimensionSettings> registry2 = p_241220_1_.func_243612_b(Registry.field_243549_ar);
        return new DimensionGeneratorSettings(p_241220_2_, p_241220_4_, p_241220_5_, DimensionGeneratorSettings.func_242749_a(registry1, DimensionType.func_242718_a(registry1, registry, registry2, p_241220_2_), this.func_241869_a(registry, registry2, p_241220_2_)));
    }

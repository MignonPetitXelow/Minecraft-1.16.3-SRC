...
public class WorldOptionsScreen implements IScreen, IRenderable
{
    ...
    public void func_239048_a_(final CreateWorldScreen p_239048_1_, Minecraft p_239048_2_, FontRenderer p_239048_3_)
    {
        ...
        })
        {
            ...
            {
                return DialogTexts.func_244281_a(super.getMessage(), WorldOptionsScreen.this.field_239039_m_.doesGenerateFeatures());
            }
        ...
        })
        {
            public ITextComponent getMessage()
            {
                return DialogTexts.func_244281_a(super.getMessage(), WorldOptionsScreen.this.field_239039_m_.hasBonusChest() && !p_239048_1_.hardCoreMode);
            }
        });
        ...
        this.field_239037_k_ = p_239048_1_.addButton(new Button(i, 185, 150, 20, new TranslationTextComponent("selectWorld.import_worldgen_settings"), (p_239049_3_) ->
        {
            ...
            if (s != null)
            {
                ...
                WorldSettingsImport<JsonElement> worldsettingsimport = WorldSettingsImport.func_244335_a(JsonOps.INSTANCE, datapackregistries.getResourceManager(), dynamicregistries$impl);
    ...
    void func_243447_a(DataPackRegistries p_243447_1_)
    {
        ...
        WorldSettingsImport<JsonElement> worldsettingsimport = WorldSettingsImport.func_244335_a(JsonOps.INSTANCE, p_243447_1_.getResourceManager(), dynamicregistries$impl);

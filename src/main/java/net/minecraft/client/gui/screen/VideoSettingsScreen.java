...
public class VideoSettingsScreen extends GuiScreenOF
{
    ...
    public VideoSettingsScreen(Screen parentScreenIn, GameSettings gameSettingsIn)
    {
        ...
        this.field_241604_x_ = this.parentGuiScreen.minecraft.func_241558_U_();
    ...
    private void checkFabulousWarning()
    {
        if (this.field_241604_x_.func_241700_g_())
        {
            ...
            this.minecraft.displayGuiScreen(new GPUWarningScreen(field_241600_q_, list, ImmutableList.of(new GPUWarningScreen.Option(field_241601_r_, (p_lambda$checkFabulousWarning$0_1_) ->
            {
    ...
    public void render(MatrixStack matrixStack, int mouseX, int mouseY, float partialTicks)
    {
        ...
        if (s1.equals("HD"))
        {
            s = "OptiFine HD G4_pre1";
        }

        if (s1.equals("HD_U"))
        {
            s = "OptiFine HD G4_pre1 Ultra";
        }

        if (s1.equals("L"))
        {
            s = "OptiFine G4_pre1 Light";
        }

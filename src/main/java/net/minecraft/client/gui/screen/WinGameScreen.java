            ...
            try
            {
                ...
                if (this.poem)
                {
                    ...
                    while ((s = bufferedreader.readLine()) != null)
                    {
                        ...
                        this.lines.addAll(this.minecraft.fontRenderer.func_238425_b_(new StringTextComponent(s), 274));
                ...
                while ((s3 = bufferedreader1.readLine()) != null)
                {
                    ...
                    for (IReorderingProcessor ireorderingprocessor : this.minecraft.fontRenderer.func_238425_b_(new StringTextComponent(s3), 274))
                    {
                        if (flag)
                        {

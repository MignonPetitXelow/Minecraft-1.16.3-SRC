        ...
        Thread thread = new Thread("Server Connector #" + CONNECTION_ID.incrementAndGet())
        {
            public void run()
            {
                ...
                catch (UnknownHostException unknownhostexception)
                {
                    ...
                    {
                        ConnectingScreen.this.minecraft.displayGuiScreen(new DisconnectedScreen(ConnectingScreen.this.previousGuiScreen, DialogTexts.field_244280_i, new TranslationTextComponent("disconnect.genericReason", "Unknown host")));
                    });
                }
                catch (Exception exception)
                {
                    ...
                    ConnectingScreen.this.minecraft.execute(() ->
                    {
                        ConnectingScreen.this.minecraft.displayGuiScreen(new DisconnectedScreen(ConnectingScreen.this.previousGuiScreen, DialogTexts.field_244280_i, new TranslationTextComponent("disconnect.genericReason", s)));
                    });
                }
            }
        };

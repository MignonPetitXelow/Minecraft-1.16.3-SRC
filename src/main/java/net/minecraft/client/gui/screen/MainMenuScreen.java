...
public class MainMenuScreen extends Screen
{
    ...
    private void addSingleplayerMultiplayerButtons(int yIn, int rowHeightIn)
    {
        ...
        Button.ITooltip button$itooltip = flag ? Button.field_238486_s_ : (p_lambda$addSingleplayerMultiplayerButtons$5_1_, p_lambda$addSingleplayerMultiplayerButtons$5_2_, p_lambda$addSingleplayerMultiplayerButtons$5_3_, p_lambda$addSingleplayerMultiplayerButtons$5_4_) ->
        {
            ...
            {
                this.renderTooltip(p_lambda$addSingleplayerMultiplayerButtons$5_2_, this.minecraft.fontRenderer.func_238425_b_(new TranslationTextComponent("title.multiplayer.disabled"), Math.max(this.width / 2 - 43, 170)), p_lambda$addSingleplayerMultiplayerButtons$5_3_, p_lambda$addSingleplayerMultiplayerButtons$5_4_);
            }
        };
    ...
    private void addDemoButtons(int yIn, int rowHeightIn)
    {
        ...
        this.addButton(new Button(this.width / 2 - 100, yIn, 200, 20, new TranslationTextComponent("menu.playdemo"), (p_lambda$addDemoButtons$8_2_) ->
        {
            if (flag)
            {
                this.minecraft.func_238191_a_("Demo_World");
            }
            else {
                DynamicRegistries.Impl dynamicregistries$impl = DynamicRegistries.func_239770_b_();
                this.minecraft.func_238192_a_("Demo_World", MinecraftServer.DEMO_WORLD_SETTINGS, dynamicregistries$impl, DimensionGeneratorSettings.func_242752_a(dynamicregistries$impl));
            }
        }));
    ...
    public void render(MatrixStack matrixStack, int mouseX, int mouseY, float partialTicks)
    {
        ...
        if ((l & -67108864) != 0)
        {
            ...
            /*
            *======================================================
            *  NEW [MODIFICATION] [String s = "Minecraft 1.18.1";]
            *  OLD [MODIFICATION] [String s = "Minecraft" + this.minecraft.getVersionType()]
            *======================================================
            */

            String s = "Minecraft 1.18.1";

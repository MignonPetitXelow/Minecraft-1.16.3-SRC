...
public class AdvancementToast implements IToast
{
    ...
    public IToast.Visibility func_230444_a_(MatrixStack p_230444_1_, ToastGui p_230444_2_, long p_230444_3_)
    {
        ...
        if (displayinfo != null)
        {
            List<IReorderingProcessor> list = p_230444_2_.getMinecraft().fontRenderer.func_238425_b_(displayinfo.getTitle(), 125);
            int i = displayinfo.getFrame() == FrameType.CHALLENGE ? 16746751 : 16776960;

            if (list.size() == 1)
            {
                p_230444_2_.getMinecraft().fontRenderer.func_243248_b(p_230444_1_, displayinfo.getFrame().func_242265_d(), 30.0F, 7.0F, i | -16777216);
            ...
            else
            {
                ...
                if (p_230444_3_ < 1500L)
                {
                    ...
                    p_230444_2_.getMinecraft().fontRenderer.func_243248_b(p_230444_1_, displayinfo.getFrame().func_242265_d(), 30.0F, 11.0F, i | k);
                }
                else
                {

...
public abstract class AbstractOption
{
    ...
    }, (p_lambda$static$2_0_, p_lambda$static$2_1_) ->
    {
        ...
        int i = (int)d0 * 2 + 1;
        return p_lambda$static$2_1_.func_243222_a(new TranslationTextComponent("options.biomeBlendRadius." + i));
    });
    ...
    }, (p_lambda$static$5_0_, p_lambda$static$5_1_) ->
    {
        ...
        return p_lambda$static$5_1_.func_243221_a(NewChatGui.calculateChatboxHeight(d0));
    });
    ...
    }, (p_lambda$static$8_0_, p_lambda$static$8_1_) ->
    {
        ...
        return p_lambda$static$8_1_.func_243221_a(NewChatGui.calculateChatboxHeight(d0));
    });
    ...
    }, (p_lambda$static$11_0_, p_lambda$static$11_1_) ->
    {
        ...
        return p_lambda$static$11_1_.func_243224_c(d0 * 0.9D + 0.1D);
    });
    ...
    }, (p_lambda$static$14_0_, p_lambda$static$14_1_) ->
    {
        ...
        return (ITextComponent)(d0 == 0.0D ? DialogTexts.func_244281_a(p_lambda$static$14_1_.func_243220_a(), false) : p_lambda$static$14_1_.func_243224_c(d0));
    });
    ...
    }, (p_lambda$static$17_0_, p_lambda$static$17_1_) ->
    {
        ...
        return p_lambda$static$17_1_.func_243221_a(NewChatGui.calculateChatboxWidth(d0 * 4.0571431D));
    });
    public static final SliderPercentageOption field_238235_g_ = new SliderPercentageOption("options.chat.line_spacing", 0.0D, 1.0D, 0.0F, (p_lambda$static$18_0_) ->
    {
    ...
    {
        return p_lambda$static$20_1_.func_243224_c(p_lambda$static$20_1_.normalizeValue(p_lambda$static$20_1_.get(p_lambda$static$20_0_)));
    });
    public static final SliderPercentageOption field_238236_h_ = new SliderPercentageOption("options.chat.delay_instant", 0.0D, 6.0D, 0.1F, (p_lambda$static$21_0_) ->
    {
    ...
    }, (p_lambda$static$26_0_, p_lambda$static$26_1_) ->
    {
        ...
        if (d0 == 70.0D)
        {
            return p_lambda$static$26_1_.func_243222_a(new TranslationTextComponent("options.fov.min"));
        }
        else {
            return d0 == p_lambda$static$26_1_.getMaxValue() ? p_lambda$static$26_1_.func_243222_a(new TranslationTextComponent("options.fov.max")) : p_lambda$static$26_1_.func_243225_c((int)d0);
        }
    });
    private static final ITextComponent field_243215_X = new TranslationTextComponent("options.fovEffectScale.tooltip");
    public static final SliderPercentageOption field_243218_j = new SliderPercentageOption("options.fovEffectScale", 0.0D, 1.0D, 0.0F, (p_lambda$static$27_0_) ->
    {
        return Math.pow((double)p_lambda$static$27_0_.field_243227_aN, 2.0D);
    }, (p_lambda$static$28_0_, p_lambda$static$28_1_) ->
    {
        p_lambda$static$28_0_.field_243227_aN = MathHelper.sqrt(p_lambda$static$28_1_);
    }, (p_lambda$static$29_0_, p_lambda$static$29_1_) ->
    {
        p_lambda$static$29_1_.func_241567_a_(Minecraft.getInstance().fontRenderer.func_238425_b_(field_243215_X, 200));
        double d0 = p_lambda$static$29_1_.normalizeValue(p_lambda$static$29_1_.get(p_lambda$static$29_0_));
        return d0 == 0.0D ? p_lambda$static$29_1_.func_243222_a(new TranslationTextComponent("options.fovEffectScale.off")) : p_lambda$static$29_1_.func_243224_c(d0);
    });
    private static final ITextComponent field_243216_Y = new TranslationTextComponent("options.screenEffectScale.tooltip");
    public static final SliderPercentageOption field_243219_k = new SliderPercentageOption("options.screenEffectScale", 0.0D, 1.0D, 0.0F, (p_lambda$static$30_0_) ->
    {
        return (double)p_lambda$static$30_0_.field_243226_aM;
    }, (p_lambda$static$31_0_, p_lambda$static$31_1_) ->
    {
        p_lambda$static$31_0_.field_243226_aM = p_lambda$static$31_1_.floatValue();
    }, (p_lambda$static$32_0_, p_lambda$static$32_1_) ->
    {
        p_lambda$static$32_1_.func_241567_a_(Minecraft.getInstance().fontRenderer.func_238425_b_(field_243216_Y, 200));
        double d0 = p_lambda$static$32_1_.normalizeValue(p_lambda$static$32_1_.get(p_lambda$static$32_0_));
        return d0 == 0.0D ? p_lambda$static$32_1_.func_243222_a(new TranslationTextComponent("options.screenEffectScale.off")) : p_lambda$static$32_1_.func_243224_c(d0);
    });
    ...
    }, (p_lambda$static$35_0_, p_lambda$static$35_1_) ->
    {
        ...
        {
            return p_lambda$static$35_1_.func_243222_a(new TranslationTextComponent("of.options.framerateLimit.vsync"));
        }
        else {
            double d0 = p_lambda$static$35_1_.get(p_lambda$static$35_0_);
            return d0 == p_lambda$static$35_1_.getMaxValue() ? p_lambda$static$35_1_.func_243222_a(new TranslationTextComponent("options.framerateLimit.max")) : p_lambda$static$35_1_.func_243222_a(new TranslationTextComponent("options.framerate", (int)d0));
        }
    });
    ...
    }, (p_lambda$static$38_0_, p_lambda$static$38_1_) ->
    {
        ...
        if (d0 == 0.0D)
        {
            return p_lambda$static$38_1_.func_243222_a(new TranslationTextComponent("options.gamma.min"));
        }
        else {
            return d0 == 1.0D ? p_lambda$static$38_1_.func_243222_a(new TranslationTextComponent("options.gamma.max")) : p_lambda$static$38_1_.func_243223_b((int)(d0 * 100.0D));
        }
    });
    ...
    }, (p_lambda$static$41_0_, p_lambda$static$41_1_) ->
    {
        ...
        if (d0 >= 4.0D)
        {
            return p_lambda$static$41_1_.func_243222_a(new TranslationTextComponent("of.general.max"));
        }
        else {
            return (ITextComponent)(d0 == 0.0D ? DialogTexts.func_244281_a(p_lambda$static$41_1_.func_243220_a(), false) : p_lambda$static$41_1_.func_243225_c((int)d0));
        }
    });
    ...
    }, (p_lambda$static$44_0_, p_lambda$static$44_1_) ->
    {
        ...
        return p_lambda$static$44_1_.func_243222_a(new StringTextComponent(String.format("%.2f", p_lambda$static$44_1_.denormalizeValue(d0))));
    });
    ...
    }, (p_lambda$static$49_0_, p_lambda$static$49_1_) ->
    {
        ...
        return p_lambda$static$49_1_.func_243222_a(new TranslationTextComponent("options.chunks", (int)d0));
    });
    public static final SliderPercentageOption field_238237_p_ = new SliderPercentageOption("options.entityDistanceScaling", 0.5D, 5.0D, 0.25F, (p_lambda$static$50_0_) ->
    {
    ...
    }, (p_lambda$static$52_0_, p_lambda$static$52_1_) ->
    {
        ...
        return p_lambda$static$52_1_.func_243224_c(d0);
    });
    ...
    }, (p_lambda$static$55_0_, p_lambda$static$55_1_) ->
    {
        ...
        if (d0 == 0.0D)
        {
            return p_lambda$static$55_1_.func_243222_a(new TranslationTextComponent("options.sensitivity.min"));
        }
        else {
            return d0 == 1.0D ? p_lambda$static$55_1_.func_243222_a(new TranslationTextComponent("options.sensitivity.max")) : p_lambda$static$55_1_.func_243224_c(2.0D * d0);
        }
    });
    ...
    {
        return p_lambda$static$58_1_.func_243224_c(p_lambda$static$58_1_.normalizeValue(p_lambda$static$58_1_.get(p_lambda$static$58_0_)));
    });
    ...
    {
        return p_lambda$static$60_1_.func_243222_a(new TranslationTextComponent(p_lambda$static$60_0_.ambientOcclusionStatus.getResourceKey()));
    });
    ...
    {
        return p_lambda$static$62_1_.func_243222_a(new TranslationTextComponent(p_lambda$static$62_0_.attackIndicator.getResourceKey()));
    });
    ...
    {
        return p_lambda$static$64_1_.func_243222_a(new TranslationTextComponent(p_lambda$static$64_0_.chatVisibility.getResourceKey()));
    });
    private static final ITextComponent field_241564_V_ = new TranslationTextComponent("options.graphics.fast.tooltip");
    private static final ITextComponent field_241565_W_ = new TranslationTextComponent("options.graphics.fabulous.tooltip", (new TranslationTextComponent("options.graphics.fabulous")).mergeStyle(TextFormatting.ITALIC));
    ...
    public static final IteratableOption GRAPHICS = new IteratableOption("options.graphics", (p_lambda$static$65_0_, p_lambda$static$65_1_) ->
    {
        ...
        if (p_lambda$static$65_0_.graphicFanciness == GraphicsFanciness.FANCY && gpuwarning.func_241695_b_())
        {
            ...
            if (p_lambda$static$65_0_.graphicFanciness == GraphicsFanciness.FABULOUS && (Config.isShaders() || !GlStateManager.func_237508_S_() || gpuwarning.func_241701_h_()))
            {
    ...
    }, (p_lambda$static$66_0_, p_lambda$static$66_1_) ->
    {
        ...
        {
            case FAST:
                p_lambda$static$66_1_.func_241567_a_(Minecraft.getInstance().fontRenderer.func_238425_b_(field_241564_V_, 200));
                break;

            case FANCY:
                p_lambda$static$66_1_.func_241567_a_(Minecraft.getInstance().fontRenderer.func_238425_b_(field_241566_X_, 200));
                break;

            case FABULOUS:
                p_lambda$static$66_1_.func_241567_a_(Minecraft.getInstance().fontRenderer.func_238425_b_(field_241565_W_, 200));
        }
        ...
        return p_lambda$static$66_0_.graphicFanciness == GraphicsFanciness.FABULOUS ? p_lambda$static$66_1_.func_243222_a(iformattabletextcomponent.mergeStyle(TextFormatting.ITALIC)) : p_lambda$static$66_1_.func_243222_a(iformattabletextcomponent);
    });
    ...
    {
        return p_lambda$static$68_0_.guiScale == 0 ? p_lambda$static$68_1_.func_243222_a(new TranslationTextComponent("options.guiScale.auto")) : p_lambda$static$68_1_.func_243225_c(p_lambda$static$68_0_.guiScale);
    });
    ...
    {
        return p_lambda$static$70_1_.func_243222_a(p_lambda$static$70_0_.mainHand.getHandName());
    });
    ...
    {
        return NarratorChatListener.INSTANCE.isActive() ? p_lambda$static$72_1_.func_243222_a(p_lambda$static$72_0_.narrator.func_238233_b_()) : p_lambda$static$72_1_.func_243222_a(new TranslationTextComponent("options.narrator.notavailable"));
    });
    ...
    {
        return p_lambda$static$74_1_.func_243222_a(new TranslationTextComponent(p_lambda$static$74_0_.particles.getResourceKey()));
    });
    ...
    {
        return p_lambda$static$76_1_.func_243222_a(new TranslationTextComponent(p_lambda$static$76_0_.cloudOption.getKey()));
    });
    ...
    {
        return p_lambda$static$78_1_.func_243222_a(new TranslationTextComponent(p_lambda$static$78_0_.accessibilityTextBackground ? "options.accessibility.text_background.chat" : "options.accessibility.text_background.everywhere"));
    });
    ...
    public static final BooleanOption CHAT_COLOR = new BooleanOption("options.chat.color", (p_lambda$static$83_0_) ->
    {
        return p_lambda$static$83_0_.chatColor;
    }, (p_lambda$static$84_0_, p_lambda$static$84_1_) ->
    {
        p_lambda$static$84_0_.chatColor = p_lambda$static$84_1_;
    });
    public static final BooleanOption CHAT_LINKS = new BooleanOption("options.chat.links", (p_lambda$static$85_0_) ->
    {
        return p_lambda$static$85_0_.chatLinks;
    }, (p_lambda$static$86_0_, p_lambda$static$86_1_) ->
    {
        p_lambda$static$86_0_.chatLinks = p_lambda$static$86_1_;
    });
    public static final BooleanOption CHAT_LINKS_PROMPT = new BooleanOption("options.chat.links.prompt", (p_lambda$static$87_0_) ->
    {
        return p_lambda$static$87_0_.chatLinksPrompt;
    }, (p_lambda$static$88_0_, p_lambda$static$88_1_) ->
    {
        p_lambda$static$88_0_.chatLinksPrompt = p_lambda$static$88_1_;
    });
    public static final BooleanOption DISCRETE_MOUSE_SCROLL = new BooleanOption("options.discrete_mouse_scroll", (p_lambda$static$89_0_) ->
    {
        return p_lambda$static$89_0_.discreteMouseScroll;
    }, (p_lambda$static$90_0_, p_lambda$static$90_1_) ->
    {
        p_lambda$static$90_0_.discreteMouseScroll = p_lambda$static$90_1_;
    });
    public static final BooleanOption VSYNC = new BooleanOption("options.vsync", (p_lambda$static$91_0_) ->
    {
        return p_lambda$static$91_0_.vsync;
    }, (p_lambda$static$92_0_, p_lambda$static$92_1_) ->
    {
        p_lambda$static$92_0_.vsync = p_lambda$static$92_1_;

        if (Minecraft.getInstance().getMainWindow() != null)
        {
            Minecraft.getInstance().getMainWindow().setVsync(p_lambda$static$92_0_.vsync);
        }
    });
    public static final BooleanOption ENTITY_SHADOWS = new BooleanOption("options.entityShadows", (p_lambda$static$93_0_) ->
    {
        return p_lambda$static$93_0_.entityShadows;
    }, (p_lambda$static$94_0_, p_lambda$static$94_1_) ->
    {
        p_lambda$static$94_0_.entityShadows = p_lambda$static$94_1_;
    });
    public static final BooleanOption FORCE_UNICODE_FONT = new BooleanOption("options.forceUnicodeFont", (p_lambda$static$95_0_) ->
    {
        return p_lambda$static$95_0_.forceUnicodeFont;
    }, (p_lambda$static$96_0_, p_lambda$static$96_1_) ->
    {
        p_lambda$static$96_0_.forceUnicodeFont = p_lambda$static$96_1_;
        Minecraft minecraft = Minecraft.getInstance();

        if (minecraft.getMainWindow() != null)
        {
            minecraft.func_238209_b_(p_lambda$static$96_1_);
        }
    });
    public static final BooleanOption INVERT_MOUSE = new BooleanOption("options.invertMouse", (p_lambda$static$97_0_) ->
    {
        return p_lambda$static$97_0_.invertMouse;
    }, (p_lambda$static$98_0_, p_lambda$static$98_1_) ->
    {
        p_lambda$static$98_0_.invertMouse = p_lambda$static$98_1_;
    });
    public static final BooleanOption REALMS_NOTIFICATIONS = new BooleanOption("options.realmsNotifications", (p_lambda$static$99_0_) ->
    {
        return p_lambda$static$99_0_.realmsNotifications;
    }, (p_lambda$static$100_0_, p_lambda$static$100_1_) ->
    {
        p_lambda$static$100_0_.realmsNotifications = p_lambda$static$100_1_;
    });
    public static final BooleanOption REDUCED_DEBUG_INFO = new BooleanOption("options.reducedDebugInfo", (p_lambda$static$101_0_) ->
    {
        return p_lambda$static$101_0_.reducedDebugInfo;
    }, (p_lambda$static$102_0_, p_lambda$static$102_1_) ->
    {
        p_lambda$static$102_0_.reducedDebugInfo = p_lambda$static$102_1_;
    });
    public static final BooleanOption SHOW_SUBTITLES = new BooleanOption("options.showSubtitles", (p_lambda$static$103_0_) ->
    {
        return p_lambda$static$103_0_.showSubtitles;
    }, (p_lambda$static$104_0_, p_lambda$static$104_1_) ->
    {
        p_lambda$static$104_0_.showSubtitles = p_lambda$static$104_1_;
    });
    public static final BooleanOption SNOOPER = new BooleanOption("options.snooper", (p_lambda$static$105_0_) ->
    {
        if (p_lambda$static$105_0_.snooper)
        {
        }
    ...
    {
        p_lambda$static$106_0_.snooper = p_lambda$static$106_1_;
    });
    public static final IteratableOption SNEAK = new IteratableOption("key.sneak", (p_lambda$static$107_0_, p_lambda$static$107_1_) ->
    {
        p_lambda$static$107_0_.toggleCrouch = !p_lambda$static$107_0_.toggleCrouch;
    }, (p_lambda$static$108_0_, p_lambda$static$108_1_) ->
    {
        return p_lambda$static$108_1_.func_243222_a(new TranslationTextComponent(p_lambda$static$108_0_.toggleCrouch ? "options.key.toggle" : "options.key.hold"));
    });
    public static final IteratableOption SPRINT = new IteratableOption("key.sprint", (p_lambda$static$109_0_, p_lambda$static$109_1_) ->
    {
        p_lambda$static$109_0_.toggleSprint = !p_lambda$static$109_0_.toggleSprint;
    }, (p_lambda$static$110_0_, p_lambda$static$110_1_) ->
    {
        return p_lambda$static$110_1_.func_243222_a(new TranslationTextComponent(p_lambda$static$110_0_.toggleSprint ? "options.key.toggle" : "options.key.hold"));
    });
    public static final BooleanOption TOUCHSCREEN = new BooleanOption("options.touchscreen", (p_lambda$static$111_0_) ->
    {
        return p_lambda$static$111_0_.touchscreen;
    }, (p_lambda$static$112_0_, p_lambda$static$112_1_) ->
    {
        p_lambda$static$112_0_.touchscreen = p_lambda$static$112_1_;
    });
    public static final BooleanOption FULLSCREEN = new BooleanOption("options.fullscreen", (p_lambda$static$113_0_) ->
    {
        return p_lambda$static$113_0_.fullscreen;
    }, (p_lambda$static$114_0_, p_lambda$static$114_1_) ->
    {
        p_lambda$static$114_0_.fullscreen = p_lambda$static$114_1_;
        Minecraft minecraft = Minecraft.getInstance();

        if (minecraft.getMainWindow() != null && minecraft.getMainWindow().isFullscreen() != p_lambda$static$114_0_.fullscreen)
        {
            minecraft.getMainWindow().toggleFullscreen();
            p_lambda$static$114_0_.fullscreen = minecraft.getMainWindow().isFullscreen();
        }
    });
    public static final BooleanOption VIEW_BOBBING = new BooleanOption("options.viewBobbing", (p_lambda$static$115_0_) ->
    {
        return p_lambda$static$115_0_.viewBobbing;
    }, (p_lambda$static$116_0_, p_lambda$static$116_1_) ->
    {
        p_lambda$static$116_0_.viewBobbing = p_lambda$static$116_1_;
    });

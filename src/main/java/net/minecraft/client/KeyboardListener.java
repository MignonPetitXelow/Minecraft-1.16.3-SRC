            ...
            switch (key)
            {
                ...
                case 67:
                    ...
                    else
                    {
                        ...
                        this.setClipboardString(String.format(Locale.ROOT, "/execute in %s run tp @s %.2f %.2f %.2f %.2f %.2f", this.mc.player.world.getDimensionKey().func_240901_a_(), this.mc.player.getPosX(), this.mc.player.getPosY(), this.mc.player.getPosZ(), this.mc.player.rotationYaw, this.mc.player.rotationPitch));
                        return true;
                    }

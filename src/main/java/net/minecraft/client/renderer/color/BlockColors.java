...
public class BlockColors
{
    ...
    public static BlockColors init()
    {
        ...
        {
            return p_228065_1_ != null && p_228065_2_ != null ? BiomeColors.getGrassColor(p_228065_1_, p_228065_0_.get(DoublePlantBlock.HALF) == DoubleBlockHalf.UPPER ? p_228065_2_.down() : p_228065_2_) : -1;
        ...
        {
            return RedstoneWireBlock.getRGBByPower(p_228059_0_.get(RedstoneWireBlock.POWER));

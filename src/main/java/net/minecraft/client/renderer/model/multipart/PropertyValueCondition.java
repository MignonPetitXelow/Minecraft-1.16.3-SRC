...
public class PropertyValueCondition implements ICondition
{
    ...
    public Predicate<BlockState> getPredicate(StateContainer<Block, BlockState> p_getPredicate_1_)
    {
        ...
        else
        {
            ...
            else
            {
                ...
                if (list.size() == 1)
                {
                    predicate = this.func_212485_a(p_getPredicate_1_, property, s);
                }
                else
                {
                    List<Predicate<BlockState>> list1 = list.stream().map((p_212482_3_) ->
                    {
                        return this.func_212485_a(p_getPredicate_1_, property, p_212482_3_);
    ...
    private Predicate<BlockState> func_212485_a(StateContainer<Block, BlockState> p_212485_1_, Property<?> p_212485_2_, String p_212485_3_)
    {

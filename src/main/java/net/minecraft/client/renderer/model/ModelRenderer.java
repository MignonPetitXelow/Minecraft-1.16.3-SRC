...
public class ModelRenderer
{
    ...
    public static class ModelBox
    {
        ...
        public ModelBox(int[][] p_i242103_1_, float p_i242103_2_, float p_i242103_3_, float p_i242103_4_, float p_i242103_5_, float p_i242103_6_, float p_i242103_7_, float p_i242103_8_, float p_i242103_9_, float p_i242103_10_, boolean p_i242103_11_, float p_i242103_12_, float p_i242103_13_)
        {
            this.posX1 = p_i242103_2_;
            this.posY1 = p_i242103_3_;
            this.posZ1 = p_i242103_4_;
            this.posX2 = p_i242103_2_ + p_i242103_5_;
            this.posY2 = p_i242103_3_ + p_i242103_6_;
            this.posZ2 = p_i242103_4_ + p_i242103_7_;
            this.quads = new ModelRenderer.TexturedQuad[6];
            float f = p_i242103_2_ + p_i242103_5_;
            float f1 = p_i242103_3_ + p_i242103_6_;
            float f2 = p_i242103_4_ + p_i242103_7_;
            p_i242103_2_ = p_i242103_2_ - p_i242103_8_;
            p_i242103_3_ = p_i242103_3_ - p_i242103_9_;
            p_i242103_4_ = p_i242103_4_ - p_i242103_10_;
            f = f + p_i242103_8_;
            f1 = f1 + p_i242103_9_;
            f2 = f2 + p_i242103_10_;
            ...
            ModelRenderer.PositionTextureVertex modelrenderer$positiontexturevertex7 = new ModelRenderer.PositionTextureVertex(p_i242103_2_, p_i242103_3_, p_i242103_4_, 0.0F, 0.0F);
            ModelRenderer.PositionTextureVertex modelrenderer$positiontexturevertex = new ModelRenderer.PositionTextureVertex(f, p_i242103_3_, p_i242103_4_, 0.0F, 8.0F);
            ModelRenderer.PositionTextureVertex modelrenderer$positiontexturevertex1 = new ModelRenderer.PositionTextureVertex(f, f1, p_i242103_4_, 8.0F, 8.0F);
            ModelRenderer.PositionTextureVertex modelrenderer$positiontexturevertex2 = new ModelRenderer.PositionTextureVertex(p_i242103_2_, f1, p_i242103_4_, 8.0F, 0.0F);
            ModelRenderer.PositionTextureVertex modelrenderer$positiontexturevertex3 = new ModelRenderer.PositionTextureVertex(p_i242103_2_, p_i242103_3_, f2, 0.0F, 0.0F);
            ModelRenderer.PositionTextureVertex modelrenderer$positiontexturevertex4 = new ModelRenderer.PositionTextureVertex(f, p_i242103_3_, f2, 0.0F, 8.0F);
            ModelRenderer.PositionTextureVertex modelrenderer$positiontexturevertex5 = new ModelRenderer.PositionTextureVertex(f, f1, f2, 8.0F, 8.0F);
            ModelRenderer.PositionTextureVertex modelrenderer$positiontexturevertex6 = new ModelRenderer.PositionTextureVertex(p_i242103_2_, f1, f2, 8.0F, 0.0F);
            this.quads[2] = this.makeTexturedQuad(new ModelRenderer.PositionTextureVertex[] {modelrenderer$positiontexturevertex4, modelrenderer$positiontexturevertex3, modelrenderer$positiontexturevertex7, modelrenderer$positiontexturevertex}, p_i242103_1_[1], true, p_i242103_12_, p_i242103_13_, p_i242103_11_, Direction.DOWN);
            this.quads[3] = this.makeTexturedQuad(new ModelRenderer.PositionTextureVertex[] {modelrenderer$positiontexturevertex1, modelrenderer$positiontexturevertex2, modelrenderer$positiontexturevertex6, modelrenderer$positiontexturevertex5}, p_i242103_1_[0], true, p_i242103_12_, p_i242103_13_, p_i242103_11_, Direction.UP);
            this.quads[1] = this.makeTexturedQuad(new ModelRenderer.PositionTextureVertex[] {modelrenderer$positiontexturevertex7, modelrenderer$positiontexturevertex3, modelrenderer$positiontexturevertex6, modelrenderer$positiontexturevertex2}, p_i242103_1_[5], false, p_i242103_12_, p_i242103_13_, p_i242103_11_, Direction.WEST);
            this.quads[4] = this.makeTexturedQuad(new ModelRenderer.PositionTextureVertex[] {modelrenderer$positiontexturevertex, modelrenderer$positiontexturevertex7, modelrenderer$positiontexturevertex2, modelrenderer$positiontexturevertex1}, p_i242103_1_[2], false, p_i242103_12_, p_i242103_13_, p_i242103_11_, Direction.NORTH);
            this.quads[0] = this.makeTexturedQuad(new ModelRenderer.PositionTextureVertex[] {modelrenderer$positiontexturevertex4, modelrenderer$positiontexturevertex, modelrenderer$positiontexturevertex1, modelrenderer$positiontexturevertex5}, p_i242103_1_[4], false, p_i242103_12_, p_i242103_13_, p_i242103_11_, Direction.EAST);
            this.quads[5] = this.makeTexturedQuad(new ModelRenderer.PositionTextureVertex[] {modelrenderer$positiontexturevertex3, modelrenderer$positiontexturevertex4, modelrenderer$positiontexturevertex5, modelrenderer$positiontexturevertex6}, p_i242103_1_[3], false, p_i242103_12_, p_i242103_13_, p_i242103_11_, Direction.SOUTH);
        }

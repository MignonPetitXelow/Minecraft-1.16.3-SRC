...
public class FaceBakery
{
    ...
    {
        int i = p_239288_1_.length / 4;
        int j = p_239288_2_ * i;
        p_239288_1_[j] = Float.floatToRawIntBits(p_239288_3_.getX());
        p_239288_1_[j + 1] = Float.floatToRawIntBits(p_239288_3_.getY());
        p_239288_1_[j + 2] = Float.floatToRawIntBits(p_239288_3_.getZ());
        p_239288_1_[j + 3] = -1;
        p_239288_1_[j + 4] = Float.floatToRawIntBits(p_239288_4_.getInterpolatedU((double)p_239288_5_.getVertexU(p_239288_2_)));
        p_239288_1_[j + 4 + 1] = Float.floatToRawIntBits(p_239288_4_.getInterpolatedV((double)p_239288_5_.getVertexV(p_239288_2_)));
    }

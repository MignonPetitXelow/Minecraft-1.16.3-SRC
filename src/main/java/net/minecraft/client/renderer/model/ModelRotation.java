...
public enum ModelRotation implements IModelTransform
{
    ...
    private final TransformationMatrix field_239507_r_;
    private final Orientation field_239508_s_;
    ...
    private ModelRotation(int x, int y)
    {
        ...
        this.field_239507_r_ = new TransformationMatrix((Vector3f)null, quaternion, (Vector3f)null, (Quaternion)null);
        this.field_239508_s_ = orientation;
    }

    public TransformationMatrix getRotation()
    {
        return this.field_239507_r_;
    }

...
public class BufferBuilder extends DefaultColorVertexBuilder implements IVertexConsumer
{
    ...
    private RenderType blockLayer = null;
    ...
    public void sortVertexData(float cameraX, float cameraY, float cameraZ)
    {
        ...
        FloatBuffer floatbuffer2 = GLAllocation.createDirectFloatBuffer(this.vertexFormat.getIntegerSize() * 4);
    ...
    public BufferBuilder.State getVertexState()
    {
        ...
        {
            int i = this.vertexCount / 4;
            atextureatlassprite = new TextureAtlasSprite[i];
            System.arraycopy(this.quadSprites, 0, atextureatlassprite, 0, i);
        }

        return new BufferBuilder.State(bytebuffer, this.vertexFormat, this.quadSprites);
    }
                ...
                if (textureatlassprite != null)
                {
                    ...
                    if (!this.drawnIcons[j1])
                    {
                        ...
                        else
                        {
                            ...
                            if (this.blockLayer != RenderTypes.TRANSLUCENT)
                            {
    ...
    public static class State
    {
        ...
        public State(ByteBuffer p_i242108_1_, VertexFormat p_i242108_2_, TextureAtlasSprite[] p_i242108_3_)
        {
            this(p_i242108_1_, p_i242108_2_);
            this.stateQuadSprites = p_i242108_3_;
        }

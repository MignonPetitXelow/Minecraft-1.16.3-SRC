...
public class ChunkRenderDispatcher
{
    ...
    public ChunkRenderDispatcher(World p_i242105_1_, WorldRenderer p_i242105_2_, Executor p_i242105_3_, boolean p_i242105_4_, RegionRenderCacheBuilder p_i242105_5_, int p_i242105_6_)
    {
        this.world = p_i242105_1_;
        this.worldRenderer = p_i242105_2_;
        ...
        int k = p_i242105_4_ ? j : Math.min(j, 4);
        ...
        this.fixedBuilder = p_i242105_5_;
        ...
        this.executor = p_i242105_3_;
        this.delegatedTaskExecutor = DelegatedTaskExecutor.create(p_i242105_3_, "Chunk Renderer");
    ...
    public class ChunkRender implements IForgeRenderChunk
    {
        ...
        private final Map<RenderType, VertexBuffer> vertexBuffers = RenderType.getBlockRenderTypes().stream().collect(Collectors.toMap((p_lambda$new$0_0_) ->
        {
        ...
        private final BlockPos.Mutable[] mapEnumFacing = Util.make(new BlockPos.Mutable[6], (p_lambda$new$2_0_) ->
        {
        ...
        abstract class ChunkRenderTask implements Comparable<ChunkRenderDispatcher.ChunkRender.ChunkRenderTask>
        {
            ...
            public ChunkRenderTask(ChunkPos p_i242102_2_, double p_i242102_3_)
            {
                this.distanceSq = p_i242102_3_;

                if (p_i242102_2_ == null)
                {
                    this.modelData = Collections.emptyMap();
                }
                else
                {
                    this.modelData = ModelDataManager.getModelData(Minecraft.getInstance().world, p_i242102_2_);
                }
            }
        ...
        class RebuildTask extends ChunkRenderDispatcher.ChunkRender.ChunkRenderTask
        {
            ...
            public RebuildTask(ChunkPos p_i242113_2_, @Nullable double p_i242113_3_, ChunkRenderCache p_i242113_5_)
            {
                super(p_i242113_2_, p_i242113_3_);
                this.chunkRenderCache = p_i242113_5_;
            }
        ...
        class SortTransparencyTask extends ChunkRenderDispatcher.ChunkRender.ChunkRenderTask
        {
            ...
            public SortTransparencyTask(ChunkPos p_i242107_2_, double p_i242107_3_, ChunkRenderDispatcher.CompiledChunk p_i242107_5_)
            {
                super(p_i242107_2_, p_i242107_3_);
                this.sortCompiledChunk = p_i242107_5_;
            }

    ...
    public void renderHand(MatrixStack p_renderHand_1_, ActiveRenderInfo p_renderHand_2_, float p_renderHand_3_, boolean p_renderHand_4_, boolean p_renderHand_5_, boolean p_renderHand_6_)
    {
        if (!this.debugView)
        {
            ...
            if (p_renderHand_4_)
            {
                ...
                if (this.mc.gameSettings.func_243230_g().func_243192_a() && !flag && !this.mc.gameSettings.hideGUI && this.mc.playerController.getCurrentGameType() != GameType.SPECTATOR)
                {
            ...
            if (this.mc.gameSettings.func_243230_g().func_243192_a() && !flag)
            {

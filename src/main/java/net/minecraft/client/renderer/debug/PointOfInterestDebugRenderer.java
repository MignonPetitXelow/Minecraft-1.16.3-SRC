...
public class PointOfInterestDebugRenderer implements DebugRenderer.IDebugRenderer
{
    ...
    {
        return this.func_239340_c_(p_217696_1_.field_217755_a).stream().map(RandomObjectDescriptor::func_229748_a_).collect(Collectors.toSet());
    }

    private Set<String> func_239342_d_(PointOfInterestDebugRenderer.POIInfo p_239342_1_)
    {
        return this.func_239343_d_(p_239342_1_.field_217755_a).stream().map(RandomObjectDescriptor::func_229748_a_).collect(Collectors.toSet());
    }

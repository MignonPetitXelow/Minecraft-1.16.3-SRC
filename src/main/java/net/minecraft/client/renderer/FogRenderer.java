...
public class FogRenderer
{
    ...
    public static void updateFogColor(ActiveRenderInfo activeRenderInfoIn, float partialTicks, ClientWorld worldIn, int renderDistanceChunks, float bossColorModifier)
    {
        ...
        else
        {
            ...
            {
                return worldIn.func_239132_a_().func_230494_a_(Vector3d.unpack(biomemanager.func_235199_a_(p_lambda$updateFogColor$0_3_, p_lambda$updateFogColor$0_4_, p_lambda$updateFogColor$0_5_).func_235080_i_()), f12);
            });

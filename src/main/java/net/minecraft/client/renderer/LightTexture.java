            ...
            if (clientworld != null)
            {
                ...
                for (int i = 0; i < 16; ++i)
                {
                    for (int j = 0; j < 16; ++j)
                    {
                        ...
                        if (Reflector.IForgeDimension_getLightmapColors.exists())
                        {
                            Reflector.call(clientworld.func_230315_m_(), Reflector.IForgeDimension_getLightmapColors, partialTicks, f9, f3, f4, vector3f1);
                        }

...
public class BlockModelRenderer
{
    ...
    public boolean renderModelSmooth(IBlockDisplayReader p_renderModelSmooth_1_, IBakedModel p_renderModelSmooth_2_, BlockState p_renderModelSmooth_3_, BlockPos p_renderModelSmooth_4_, MatrixStack p_renderModelSmooth_5_, IVertexBuilder p_renderModelSmooth_6_, boolean p_renderModelSmooth_7_, Random p_renderModelSmooth_8_, long p_renderModelSmooth_9_, int p_renderModelSmooth_11_, IModelData p_renderModelSmooth_12_)
    {
        ...
        RenderType rendertype = p_renderModelSmooth_6_.getBlockLayer();
    ...
    public boolean renderModelFlat(IBlockDisplayReader p_renderModelFlat_1_, IBakedModel p_renderModelFlat_2_, BlockState p_renderModelFlat_3_, BlockPos p_renderModelFlat_4_, MatrixStack p_renderModelFlat_5_, IVertexBuilder p_renderModelFlat_6_, boolean p_renderModelFlat_7_, Random p_renderModelFlat_8_, long p_renderModelFlat_9_, int p_renderModelFlat_11_, IModelData p_renderModelFlat_12_)
    {
        ...
        RenderType rendertype = p_renderModelFlat_6_.getBlockLayer();
    ...
    private void renderQuadsSmooth(IBlockDisplayReader p_renderQuadsSmooth_1_, BlockState p_renderQuadsSmooth_2_, BlockPos p_renderQuadsSmooth_3_, MatrixStack p_renderQuadsSmooth_4_, IVertexBuilder p_renderQuadsSmooth_5_, List<BakedQuad> p_renderQuadsSmooth_6_, int p_renderQuadsSmooth_7_, RenderEnv p_renderQuadsSmooth_8_)
    {
        ...
        for (int j = 0; j < i; ++j)
        {
            ...
            blockmodelrenderer$ambientocclusionface.func_239285_a_(p_renderQuadsSmooth_1_, p_renderQuadsSmooth_2_, p_renderQuadsSmooth_3_, bakedquad.getFace(), afloat, bitset, bakedquad.func_239287_f_());
    ...
    private void renderQuadsFlat(IBlockDisplayReader p_renderQuadsFlat_1_, BlockState p_renderQuadsFlat_2_, BlockPos p_renderQuadsFlat_3_, int p_renderQuadsFlat_4_, int p_renderQuadsFlat_5_, boolean p_renderQuadsFlat_6_, MatrixStack p_renderQuadsFlat_7_, IVertexBuilder p_renderQuadsFlat_8_, List<BakedQuad> p_renderQuadsFlat_9_, RenderEnv p_renderQuadsFlat_10_)
    {
        ...
        for (int j = 0; j < i; ++j)
        {
            ...
            float f = p_renderQuadsFlat_1_.func_230487_a_(bakedquad.getFace(), bakedquad.func_239287_f_());
    ...
    public static class AmbientOcclusionFace
    {
        ...
        public void func_239285_a_(IBlockDisplayReader p_239285_1_, BlockState p_239285_2_, BlockPos p_239285_3_, Direction p_239285_4_, float[] p_239285_5_, BitSet p_239285_6_, boolean p_239285_7_)
        {
            ...
            BlockModelRenderer.NeighborInfo blockmodelrenderer$neighborinfo = BlockModelRenderer.NeighborInfo.getNeighbourInfo(p_239285_4_);
            ...
            BlockState blockstate = p_239285_1_.getBlockState(blockposm);
            int i = LightCacheOF.getPackedLight(blockstate, p_239285_1_, blockposm);
            float f = LightCacheOF.getBrightness(blockstate, p_239285_1_, blockposm);
            blockposm.setPosOffset(blockpos, blockmodelrenderer$neighborinfo.corners[1]);
            BlockState blockstate1 = p_239285_1_.getBlockState(blockposm);
            int j = LightCacheOF.getPackedLight(blockstate1, p_239285_1_, blockposm);
            float f1 = LightCacheOF.getBrightness(blockstate1, p_239285_1_, blockposm);
            blockposm.setPosOffset(blockpos, blockmodelrenderer$neighborinfo.corners[2]);
            BlockState blockstate2 = p_239285_1_.getBlockState(blockposm);
            int k = LightCacheOF.getPackedLight(blockstate2, p_239285_1_, blockposm);
            float f2 = LightCacheOF.getBrightness(blockstate2, p_239285_1_, blockposm);
            blockposm.setPosOffset(blockpos, blockmodelrenderer$neighborinfo.corners[3]);
            BlockState blockstate3 = p_239285_1_.getBlockState(blockposm);
            int l = LightCacheOF.getPackedLight(blockstate3, p_239285_1_, blockposm);
            float f3 = LightCacheOF.getBrightness(blockstate3, p_239285_1_, blockposm);
            blockposm.setPosOffset(blockpos, blockmodelrenderer$neighborinfo.corners[0], p_239285_4_);
            boolean flag = p_239285_1_.getBlockState(blockposm).getOpacity(p_239285_1_, blockposm) == 0;
            blockposm.setPosOffset(blockpos, blockmodelrenderer$neighborinfo.corners[1], p_239285_4_);
            boolean flag1 = p_239285_1_.getBlockState(blockposm).getOpacity(p_239285_1_, blockposm) == 0;
            blockposm.setPosOffset(blockpos, blockmodelrenderer$neighborinfo.corners[2], p_239285_4_);
            boolean flag2 = p_239285_1_.getBlockState(blockposm).getOpacity(p_239285_1_, blockposm) == 0;
            blockposm.setPosOffset(blockpos, blockmodelrenderer$neighborinfo.corners[3], p_239285_4_);
            boolean flag3 = p_239285_1_.getBlockState(blockposm).getOpacity(p_239285_1_, blockposm) == 0;
            float f4;
            int i1;
            ...
            else
            {
                ...
                BlockState blockstate4 = p_239285_1_.getBlockState(blockposm);
                f4 = LightCacheOF.getBrightness(blockstate4, p_239285_1_, blockposm);
                i1 = LightCacheOF.getPackedLight(blockstate4, p_239285_1_, blockposm);
            }
            ...
            else
            {
                ...
                BlockState blockstate5 = p_239285_1_.getBlockState(blockposm);
                f26 = LightCacheOF.getBrightness(blockstate5, p_239285_1_, blockposm);
                j1 = LightCacheOF.getPackedLight(blockstate5, p_239285_1_, blockposm);
            }
            ...
            else
            {
                ...
                BlockState blockstate6 = p_239285_1_.getBlockState(blockposm);
                f27 = LightCacheOF.getBrightness(blockstate6, p_239285_1_, blockposm);
                k1 = LightCacheOF.getPackedLight(blockstate6, p_239285_1_, blockposm);
            }
            ...
            else
            {
                ...
                BlockState blockstate7 = p_239285_1_.getBlockState(blockposm);
                f28 = LightCacheOF.getBrightness(blockstate7, p_239285_1_, blockposm);
                l1 = LightCacheOF.getPackedLight(blockstate7, p_239285_1_, blockposm);
            }

            int i3 = LightCacheOF.getPackedLight(p_239285_2_, p_239285_1_, p_239285_3_);
            blockposm.setPosOffset(p_239285_3_, p_239285_4_);
            BlockState blockstate8 = p_239285_1_.getBlockState(blockposm);

            if (p_239285_6_.get(0) || !blockstate8.isOpaqueCube(p_239285_1_, blockposm))
            {
                i3 = LightCacheOF.getPackedLight(blockstate8, p_239285_1_, blockposm);
            }

            float f5 = p_239285_6_.get(0) ? LightCacheOF.getBrightness(p_239285_1_.getBlockState(blockpos), p_239285_1_, blockpos) : LightCacheOF.getBrightness(p_239285_1_.getBlockState(p_239285_3_), p_239285_1_, p_239285_3_);
            BlockModelRenderer.VertexTranslations blockmodelrenderer$vertextranslations = BlockModelRenderer.VertexTranslations.getVertexTranslations(p_239285_4_);
            ...
            if (p_239285_6_.get(1) && blockmodelrenderer$neighborinfo.doNonCubicWeight)
            {
                ...
                float f10 = p_239285_5_[blockmodelrenderer$neighborinfo.vert0Weights[0].shape] * p_239285_5_[blockmodelrenderer$neighborinfo.vert0Weights[1].shape];
                float f11 = p_239285_5_[blockmodelrenderer$neighborinfo.vert0Weights[2].shape] * p_239285_5_[blockmodelrenderer$neighborinfo.vert0Weights[3].shape];
                float f12 = p_239285_5_[blockmodelrenderer$neighborinfo.vert0Weights[4].shape] * p_239285_5_[blockmodelrenderer$neighborinfo.vert0Weights[5].shape];
                float f13 = p_239285_5_[blockmodelrenderer$neighborinfo.vert0Weights[6].shape] * p_239285_5_[blockmodelrenderer$neighborinfo.vert0Weights[7].shape];
                float f14 = p_239285_5_[blockmodelrenderer$neighborinfo.vert1Weights[0].shape] * p_239285_5_[blockmodelrenderer$neighborinfo.vert1Weights[1].shape];
                float f15 = p_239285_5_[blockmodelrenderer$neighborinfo.vert1Weights[2].shape] * p_239285_5_[blockmodelrenderer$neighborinfo.vert1Weights[3].shape];
                float f16 = p_239285_5_[blockmodelrenderer$neighborinfo.vert1Weights[4].shape] * p_239285_5_[blockmodelrenderer$neighborinfo.vert1Weights[5].shape];
                float f17 = p_239285_5_[blockmodelrenderer$neighborinfo.vert1Weights[6].shape] * p_239285_5_[blockmodelrenderer$neighborinfo.vert1Weights[7].shape];
                float f18 = p_239285_5_[blockmodelrenderer$neighborinfo.vert2Weights[0].shape] * p_239285_5_[blockmodelrenderer$neighborinfo.vert2Weights[1].shape];
                float f19 = p_239285_5_[blockmodelrenderer$neighborinfo.vert2Weights[2].shape] * p_239285_5_[blockmodelrenderer$neighborinfo.vert2Weights[3].shape];
                float f20 = p_239285_5_[blockmodelrenderer$neighborinfo.vert2Weights[4].shape] * p_239285_5_[blockmodelrenderer$neighborinfo.vert2Weights[5].shape];
                float f21 = p_239285_5_[blockmodelrenderer$neighborinfo.vert2Weights[6].shape] * p_239285_5_[blockmodelrenderer$neighborinfo.vert2Weights[7].shape];
                float f22 = p_239285_5_[blockmodelrenderer$neighborinfo.vert3Weights[0].shape] * p_239285_5_[blockmodelrenderer$neighborinfo.vert3Weights[1].shape];
                float f23 = p_239285_5_[blockmodelrenderer$neighborinfo.vert3Weights[2].shape] * p_239285_5_[blockmodelrenderer$neighborinfo.vert3Weights[3].shape];
                float f24 = p_239285_5_[blockmodelrenderer$neighborinfo.vert3Weights[4].shape] * p_239285_5_[blockmodelrenderer$neighborinfo.vert3Weights[5].shape];
                float f25 = p_239285_5_[blockmodelrenderer$neighborinfo.vert3Weights[6].shape] * p_239285_5_[blockmodelrenderer$neighborinfo.vert3Weights[7].shape];

...
public class Atlases
{
    ...
    private static final RenderType field_239279_C_ = RenderType.func_239268_f_(AtlasTexture.LOCATION_BLOCKS_TEXTURE);
    ...
    public static final List<RenderMaterial> SHULKER_TEXTURES = Stream.of("white", "orange", "magenta", "light_blue", "yellow", "lime", "pink", "gray", "light_gray", "cyan", "purple", "blue", "brown", "green", "red", "black").map((p_228777_0_) ->
    {
        return new RenderMaterial(SHULKER_BOX_ATLAS, new ResourceLocation("entity/shulker/shulker_" + p_228777_0_));
    ...
    {
        return new RenderMaterial(BED_ATLAS, new ResourceLocation("entity/bed/" + p_228770_0_.getTranslationKey()));
    }).toArray((p_228769_0_) ->
    {
    ...
    public static RenderType func_239280_i_()
    {
        return field_239279_C_;
    }
    ...
    public static void collectAllMaterials(Consumer<RenderMaterial> p_228775_0_)
    {
        ...
        {
            p_228775_0_.accept(new RenderMaterial(BANNER_ATLAS, bannerpattern.getTextureLocation(true)));
            p_228775_0_.accept(new RenderMaterial(SHIELD_ATLAS, bannerpattern.getTextureLocation(false)));
        }
    ...
    public static RenderMaterial getSignMaterial(WoodType p_228773_0_)
    {
        return new RenderMaterial(SIGN_ATLAS, new ResourceLocation("entity/signs/" + p_228773_0_.getName()));
    }

    private static RenderMaterial getChestMaterial(String p_228774_0_)
    {
        return new RenderMaterial(CHEST_ATLAS, new ResourceLocation("entity/chest/" + p_228774_0_));
    }

    public static RenderMaterial getChestMaterial(TileEntity p_228771_0_, ChestType p_228771_1_, boolean p_228771_2_)
    {
        if (p_228771_2_)
        {
    ...
    private static RenderMaterial getChestMaterial(ChestType p_228772_0_, RenderMaterial p_228772_1_, RenderMaterial p_228772_2_, RenderMaterial p_228772_3_)
    {
        switch (p_228772_0_)
        {
            case LEFT:

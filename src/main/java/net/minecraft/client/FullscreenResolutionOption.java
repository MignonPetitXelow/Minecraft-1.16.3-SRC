    ...
    private FullscreenResolutionOption(MainWindow mainWindowIn, @Nullable Monitor monitorIn)
    {
        ...
        }, (p_225305_1_, p_225305_2_) ->
        {
            if (monitorIn == null)
            {
                ...
                return d0 == -1.0D ? p_225305_2_.func_243222_a(new TranslationTextComponent("options.fullscreen.current")) : p_225305_2_.func_243222_a(new StringTextComponent(monitorIn.getVideoModeFromIndex((int)d0).toString()));
            }
        });
    }
}

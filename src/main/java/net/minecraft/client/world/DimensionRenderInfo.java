...
public abstract class DimensionRenderInfo
{
    private static final Object2ObjectMap<ResourceLocation, DimensionRenderInfo> field_239208_a_ = Util.make(new Object2ObjectArrayMap<>(), (p_239214_0_) ->
    {
        ...
        p_239214_0_.put(DimensionType.field_242710_a, dimensionrenderinfo$overworld);
        p_239214_0_.put(DimensionType.field_242711_b, new DimensionRenderInfo.Nether());
        p_239214_0_.put(DimensionType.field_242712_c, new DimensionRenderInfo.End());
    });
    ...
    {
        return field_239208_a_.get(p_243495_0_.func_242725_p());
    }

...
public class ClientWorld extends World
{
    ...
    public void animateTick(int x, int y, int z, int offset, Random random, boolean holdingBarrier, BlockPos.Mutable pos)
    {
        ...
        {
            this.getBiome(pos).func_235090_t_().ifPresent((p_lambda$animateTick$4_2_) ->
            {
    ...
    {
        return this.func_241828_r().func_243612_b(Registry.BIOME_KEY).func_243576_d(Biomes.PLAINS);
    }

...
public class LanternBlock extends Block implements IWaterLoggable
{
    ...
    public static final BooleanProperty field_242675_b = BlockStateProperties.WATERLOGGED;
    ...
    {
        super(properties);
        this.setDefaultState(this.stateContainer.getBaseState().with(HANGING, Boolean.valueOf(false)).with(field_242675_b, Boolean.valueOf(false)));
    }
    ...
    public BlockState getStateForPlacement(BlockItemUseContext context)
    {
        ...
        for (Direction direction : context.getNearestLookingDirections())
        {
            if (direction.getAxis() == Direction.Axis.Y)
            {
                ...
                {
                    return blockstate.with(field_242675_b, Boolean.valueOf(fluidstate.getFluid() == Fluids.WATER));
                }
            }
        }
    ...
    {
        builder.add(HANGING, field_242675_b);
    }
    ...
    {
        return state.get(field_242675_b) ? Fluids.WATER.getStillFluidState(false) : super.getFluidState(state);
    }

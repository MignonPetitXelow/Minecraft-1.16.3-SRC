...
public abstract class AbstractFireBlock extends Block
{
    ...
    public static BlockState getFireForPlacement(IBlockReader reader, BlockPos pos)
    {
        ...
        return SoulFireBlock.func_235577_c_(blockstate.getBlock()) ? Blocks.SOUL_FIRE.getDefaultState() : ((FireBlock)Blocks.FIRE).getStateForPlacement(reader, pos);
    }
    ...
    {
        return p_242649_0_.getDimensionKey() == World.OVERWORLD || p_242649_0_.getDimensionKey() == World.THE_NETHER;
    }
    ...
    public static boolean canLightBlock(World world, BlockPos pos, Direction p_241465_2_)
    {
        ...
        {
            return getFireForPlacement(world, pos).isValidPosition(world, pos) || shouldLightPortal(world, pos, p_241465_2_);
        }
    }

    private static boolean shouldLightPortal(World world, BlockPos pos, Direction p_241466_2_)
    {
        ...
        else
        {
            ...
            return flag && PortalSize.func_242964_a(world, pos, p_241466_2_.rotateYCCW().getAxis()).isPresent();
        }
    }
}

...
public class StonecutterBlock extends Block
{
    ...
    {
        return new SimpleNamedContainerProvider((p_220283_2_, inventory, player) ->
        {
            return new StonecutterContainer(p_220283_2_, inventory, IWorldPosCallable.of(worldIn, pos));
        }, CONTAINER_NAME);
    }

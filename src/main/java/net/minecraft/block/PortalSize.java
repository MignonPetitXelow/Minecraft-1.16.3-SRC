...
public class PortalSize
{
    ...
    {
        for (int i = Math.max(0, p_242971_1_.getY() - 21); p_242971_1_.getY() > i && canConnect(this.world.getBlockState(p_242971_1_.down())); p_242971_1_ = p_242971_1_.down())
        {
        }
    ...
    private static boolean canConnect(BlockState p_196900_0_)
    {
        return p_196900_0_.isAir() || p_196900_0_.isIn(BlockTags.FIRE) || p_196900_0_.isIn(Blocks.NETHER_PORTAL);
    }

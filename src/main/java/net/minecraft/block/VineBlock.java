...
public class VineBlock extends Block
{
    ...
    private boolean func_196543_i(BlockState state)
    {
    ...
    private boolean func_196541_a(IBlockReader blockReader, BlockPos pos, Direction direction)
    {
    ...
    private BlockState func_196545_h(BlockState state, IBlockReader blockReader, BlockPos pos)
    {
        ...
        for (Direction direction : Direction.Plane.HORIZONTAL)
        {
            ...
            if (state.get(booleanproperty))
            {
                boolean flag = this.func_196541_a(blockReader, pos, direction);
    ...
    private boolean func_196540_x(BlockState state)
    {
        return state.get(NORTH) || state.get(EAST) || state.get(SOUTH) || state.get(WEST);
    }

    private boolean func_196539_a(IBlockReader blockReader, BlockPos pos)
    {
        int i = 4;

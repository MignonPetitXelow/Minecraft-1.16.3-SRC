...
public class ScaffoldingBlock extends Block implements IWaterLoggable
{
    ...
    public BlockState getStateForPlacement(BlockItemUseContext context)
    {
        ...
        return this.getDefaultState().with(WATERLOGGED, Boolean.valueOf(world.getFluidState(blockpos).getFluid() == Fluids.WATER)).with(DISTANCE, Integer.valueOf(i)).with(BOTTOM, Boolean.valueOf(this.func_220116_a(world, blockpos, i)));
    }
    ...
    private boolean func_220116_a(IBlockReader blockReader, BlockPos pos, int p_220116_3_)
    {
        return p_220116_3_ > 0 && !blockReader.getBlockState(pos.down()).isIn(this);
    }

    public static int func_220117_a(IBlockReader blockReader, BlockPos pos)
    {

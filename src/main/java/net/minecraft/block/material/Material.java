...
public final class Material
{
    ...
    public static final Material field_242934_h = (new Material.Builder(MaterialColor.FOLIAGE)).doesNotBlockMovement().notOpaque().notSolid().pushDestroys().replaceable().build();

    ...
    public void func_230230_a_(Consumer<ResourcePackInfo> p_230230_1_, ResourcePackInfo.IFactory p_230230_2_)
    {
        ...
        if (afile != null)
        {
            for (File file1 : afile)
            {
                ...
                ResourcePackInfo resourcepackinfo = ResourcePackInfo.createResourcePack(s, false, this.makePackSupplier(file1), p_230230_2_, ResourcePackInfo.Priority.TOP, this.field_232610_c_);

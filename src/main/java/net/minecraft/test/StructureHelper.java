...
public class StructureHelper
{
    ...
    private static void func_229591_a_(int p_229591_0_, BlockPos p_229591_1_, ServerWorld p_229591_2_)
    {
        ...
        FlatGenerationSettings flatgenerationsettings = FlatGenerationSettings.func_242869_a(p_229591_2_.func_241828_r().func_243612_b(Registry.BIOME_KEY));
        ...
        {
            blockstate = p_229591_2_.getBiome(p_229591_1_).func_242440_e().func_242502_e().getTop();
        }
        else if (p_229591_1_.getY() < p_229591_0_ - 1)
        {
            blockstate = p_229591_2_.getBiome(p_229591_1_).func_242440_e().func_242502_e().getUnder();
        }

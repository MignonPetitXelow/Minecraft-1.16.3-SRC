...
public class FunctionManager
{
    ...
    public void tick()
    {
        ...
        if (this.loadFunctionsRun)
        {
            ...
            Collection<FunctionObject> collection = this.reloader.func_240942_b_().func_241834_b(LOAD_TAG_ID).getAllElements();
    ...
    private void clearAndResetTickFunctions(FunctionReloader reloader)
    {
        ...
        this.tickFunctions.addAll(reloader.func_240942_b_().func_241834_b(TICK_TAG_ID).getAllElements());

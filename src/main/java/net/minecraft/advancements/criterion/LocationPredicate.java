...
public class LocationPredicate
{
    ...
    {
        return new LocationPredicate(MinMaxBounds.FloatBound.UNBOUNDED, MinMaxBounds.FloatBound.UNBOUNDED, MinMaxBounds.FloatBound.UNBOUNDED, p_242665_0_, (Structure<?>)null, (RegistryKey<World>)null, (Boolean)null, LightPredicate.ANY, BlockPredicate.ANY, FluidPredicate.ANY);
    }
    ...
    public boolean test(ServerWorld world, float x, float y, float z)
    {
        ...
        else
        {
            ...
            Optional<RegistryKey<Biome>> optional = world.func_241828_r().func_243612_b(Registry.BIOME_KEY).func_230519_c_(world.getBiome(blockpos));
    ...
    public static LocationPredicate deserialize(@Nullable JsonElement element)
    {
        if (element != null && !element.isJsonNull())
        {
            ...
            {
                return RegistryKey.func_240903_a_(Registry.WORLD_KEY, dimensionKey);
            ...
            if (jsonobject.has("biome"))
            {
                ...
                registrykey1 = RegistryKey.func_240903_a_(Registry.BIOME_KEY, resourcelocation);
            }

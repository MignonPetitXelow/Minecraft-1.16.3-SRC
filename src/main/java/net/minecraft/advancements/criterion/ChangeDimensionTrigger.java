...
public class ChangeDimensionTrigger extends AbstractCriterionTrigger<ChangeDimensionTrigger.Instance>
{
    ...
    {
        RegistryKey<World> registrykey = json.has("from") ? RegistryKey.func_240903_a_(Registry.WORLD_KEY, new ResourceLocation(JSONUtils.getString(json, "from"))) : null;
        RegistryKey<World> registrykey1 = json.has("to") ? RegistryKey.func_240903_a_(Registry.WORLD_KEY, new ResourceLocation(JSONUtils.getString(json, "to"))) : null;

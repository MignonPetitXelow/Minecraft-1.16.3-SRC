        ...
        if (element != null && !element.isJsonNull())
        {
            ...
            else
            {
                ...
                if (jsonobject.has("item"))
                {
                    ...
                    item = Registry.ITEM.func_241873_b(resourcelocation).orElseThrow(() ->
                    {
                ...
                if (jsonobject.has("tag"))
                {
                    ...
                    itag = TagCollectionManager.func_242178_a().func_241836_b().get(resourcelocation1);
                ...
                if (jsonobject.has("potion"))
                {
                    ...
                    potion = Registry.POTION.func_241873_b(resourcelocation2).orElseThrow(() ->
                    {

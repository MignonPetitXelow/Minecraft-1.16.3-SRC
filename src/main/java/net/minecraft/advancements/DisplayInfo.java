...
public class DisplayInfo
{
    ...
    {
        ITextComponent itextcomponent = ITextComponent.Serializer.func_240641_a_(object.get("title"));
        ITextComponent itextcomponent1 = ITextComponent.Serializer.func_240641_a_(object.get("description"));

...
public class ScoreCriteria
{
    ...
    public static Optional<ScoreCriteria> func_216390_a(String p_216390_0_)
    {
        ...
        else
        {
            ...
            return i < 0 ? Optional.empty() : Registry.STATS.func_241873_b(ResourceLocation.create(p_216390_0_.substring(0, i), '.')).flatMap((p_216392_2_) ->
            {
    ...
    {
        return p_216391_0_.getRegistry().func_241873_b(p_216391_1_).map(p_216391_0_::get);
    }

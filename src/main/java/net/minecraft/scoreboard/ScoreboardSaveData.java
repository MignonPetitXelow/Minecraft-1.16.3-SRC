...
public class ScoreboardSaveData extends WorldSavedData
{
    ...
    protected void readTeams(ListNBT tagList)
    {
        for (int i = 0; i < tagList.size(); ++i)
        {
            ...
            ITextComponent itextcomponent = ITextComponent.Serializer.func_240643_a_(compoundnbt.getString("DisplayName"));
            ...
            {
                ITextComponent itextcomponent1 = ITextComponent.Serializer.func_240643_a_(compoundnbt.getString("MemberNamePrefix"));
            ...
            {
                ITextComponent itextcomponent2 = ITextComponent.Serializer.func_240643_a_(compoundnbt.getString("MemberNameSuffix"));

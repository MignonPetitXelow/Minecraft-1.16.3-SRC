...
public final class NBTUtil
{
    ...
    public static UUID readUniqueId(INBT tag)
    {
        ...
        {
            throw new IllegalArgumentException("Expected UUID-Tag to be of type " + IntArrayNBT.TYPE.func_225648_a_() + ", but found " + tag.getType().func_225648_a_() + ".");
        }
        else
        {
    ...
    {
        return (CompoundNBT)dataFixer.update(type.func_219816_a(), new Dynamic<>(NBTDynamicOps.INSTANCE, nbt), version, newVersion).getValue();
    }
}

        ...
        if (p_207186_1_.getGameRules().getBoolean(GameRules.DO_FIRE_TICK))
        {
            ...
            if (i > 0)
            {
                ...
                for (int j = 0; j < i; ++j)
                {
                    ...
                    if (blockstate.isAir())
                    {
                        ...
                        {
                            p_207186_1_.setBlockState(blockpos, AbstractFireBlock.getFireForPlacement(p_207186_1_, blockpos));
                            return;
                        }
                    }
            ...
            else
            {
                for (int k = 0; k < 3; ++k)
                {
                    ...
                    {
                        p_207186_1_.setBlockState(blockpos1.up(), AbstractFireBlock.getFireForPlacement(p_207186_1_, blockpos1));
                    }
                }
            }
        }

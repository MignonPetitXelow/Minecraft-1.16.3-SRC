    ...
    private void spawnZombie(ServerWorld p_75530_1_)
    {
        ...
        if (vector3d != null)
        {
            ...
            try
            {
                ...
                zombieentity.onInitialSpawn(p_75530_1_, p_75530_1_.getDifficultyForLocation(zombieentity.getPosition()), SpawnReason.EVENT, (ILivingEntityData)null, (CompoundNBT)null);
            }

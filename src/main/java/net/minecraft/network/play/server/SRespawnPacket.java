...
public class SRespawnPacket implements IPacket<IClientPlayNetHandler>
{
    ...
    {
        this.field_240822_a_ = buf.func_240628_a_(DimensionType.field_236002_f_).get();
        this.dimensionID = RegistryKey.func_240903_a_(Registry.WORLD_KEY, buf.readResourceLocation());

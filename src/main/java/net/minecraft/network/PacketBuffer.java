...
public class PacketBuffer extends ByteBuf implements IForgePacketBuffer
{
    ...
    public PacketBuffer(ByteBuf p_i242106_1_, Map<String, Object> p_i242106_2_)
    {
        this.buf = p_i242106_1_;
        this.customData = p_i242106_2_;
    }

...
public class ItemModelsProperties
{
    ...
    private static IItemPropertyGetter func_239420_a_(ResourceLocation p_239420_0_, IItemPropertyGetter p_239420_1_)
    {
        field_239410_a_.put(p_239420_0_, p_239420_1_);
        return p_239420_1_;
    }

    private static void func_239418_a_(Item p_239418_0_, ResourceLocation p_239418_1_, IItemPropertyGetter p_239418_2_)
    {
        field_239415_f_.computeIfAbsent(p_239418_0_, (p_239416_0_) ->
        {
    ...
    public static IItemPropertyGetter func_239417_a_(Item p_239417_0_, ResourceLocation p_239417_1_)
    {
        ...
        {
            if (field_239412_c_.equals(p_239417_1_))
            {
                return field_239414_e_;
            }

            if (field_239411_b_.equals(p_239417_1_))
            {
                return field_239413_d_;
            }
        }

        IItemPropertyGetter iitempropertygetter = field_239410_a_.get(p_239417_1_);
        ...
        {
            Map<ResourceLocation, IItemPropertyGetter> map = field_239415_f_.get(p_239417_0_);
    ...
    static
    {
        func_239420_a_(new ResourceLocation("lefthanded"), (p_239432_0_, p_239432_1_, p_239432_2_) ->
        {
            return p_239432_2_ != null && p_239432_2_.getPrimaryHand() != HandSide.RIGHT ? 1.0F : 0.0F;
        });
        func_239420_a_(new ResourceLocation("cooldown"), (p_239431_0_, p_239431_1_, p_239431_2_) ->
        {
        ...
        func_239420_a_(new ResourceLocation("custom_model_data"), (p_239430_0_, p_239430_1_, p_239430_2_) ->
        {
            return p_239430_0_.hasTag() ? (float)p_239430_0_.getTag().getInt("CustomModelData") : 0.0F;
        });
        func_239418_a_(Items.BOW, new ResourceLocation("pull"), (p_239429_0_, p_239429_1_, p_239429_2_) ->
        {
            if (p_239429_2_ == null)
            {
                return 0.0F;
        ...
        func_239418_a_(Items.CLOCK, new ResourceLocation("time"), new IItemPropertyGetter()
        {
            ...
            public float call(ItemStack p_call_1_, @Nullable ClientWorld p_call_2_, @Nullable LivingEntity p_call_3_)
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        if (p_call_2_.func_230315_m_().func_236043_f_())
                        {
        ...
        func_239418_a_(Items.COMPASS, new ResourceLocation("angle"), new IItemPropertyGetter()
        {
        ...
        func_239418_a_(Items.CROSSBOW, new ResourceLocation("pull"), (p_239427_0_, p_239427_1_, p_239427_2_) ->
        {
            if (p_239427_2_ == null)
            {
                return 0.0F;
        ...
        func_239418_a_(Items.CROSSBOW, new ResourceLocation("pulling"), (p_239426_0_, p_239426_1_, p_239426_2_) ->
        {
        ...
        func_239418_a_(Items.CROSSBOW, new ResourceLocation("charged"), (p_239425_0_, p_239425_1_, p_239425_2_) ->
        {
            return p_239425_2_ != null && CrossbowItem.isCharged(p_239425_0_) ? 1.0F : 0.0F;
        });
        func_239418_a_(Items.CROSSBOW, new ResourceLocation("firework"), (p_239424_0_, p_239424_1_, p_239424_2_) ->
        {
        ...
        func_239418_a_(Items.ELYTRA, new ResourceLocation("broken"), (p_239423_0_, p_239423_1_, p_239423_2_) ->
        {
            return ElytraItem.isUsable(p_239423_0_) ? 0.0F : 1.0F;
        });
        func_239418_a_(Items.FISHING_ROD, new ResourceLocation("cast"), (p_239422_0_, p_239422_1_, p_239422_2_) ->
        {
            if (p_239422_2_ == null)
            {
                return 0.0F;
        ...
        func_239418_a_(Items.SHIELD, new ResourceLocation("blocking"), (p_239421_0_, p_239421_1_, p_239421_2_) ->
        {
            return p_239421_2_ != null && p_239421_2_.isHandActive() && p_239421_2_.getActiveItemStack() == p_239421_0_ ? 1.0F : 0.0F;
        });
        func_239418_a_(Items.TRIDENT, new ResourceLocation("throwing"), (p_239419_0_, p_239419_1_, p_239419_2_) ->
        {

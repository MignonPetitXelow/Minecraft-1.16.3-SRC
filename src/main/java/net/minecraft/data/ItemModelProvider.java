...
public class ItemModelProvider
{
    ...
    public void func_240074_a_()
    {
        ...
        this.func_240076_a_(Items.WARPED_FUNGUS_ON_A_STICK, StockModelShapes.field_240275_aM_);
        ...
        this.func_240076_a_(Items.MUSIC_DISC_PIGSTEP, StockModelShapes.field_240273_aK_);
        ...
        this.func_240076_a_(Items.NETHERITE_AXE, StockModelShapes.field_240274_aL_);
        this.func_240076_a_(Items.NETHERITE_BOOTS, StockModelShapes.field_240273_aK_);
        this.func_240076_a_(Items.NETHERITE_CHESTPLATE, StockModelShapes.field_240273_aK_);
        this.func_240076_a_(Items.NETHERITE_HELMET, StockModelShapes.field_240273_aK_);
        this.func_240076_a_(Items.NETHERITE_HOE, StockModelShapes.field_240274_aL_);
        this.func_240076_a_(Items.NETHERITE_INGOT, StockModelShapes.field_240273_aK_);
        this.func_240076_a_(Items.NETHERITE_LEGGINGS, StockModelShapes.field_240273_aK_);
        this.func_240076_a_(Items.NETHERITE_PICKAXE, StockModelShapes.field_240274_aL_);
        this.func_240076_a_(Items.NETHERITE_SCRAP, StockModelShapes.field_240273_aK_);
        this.func_240076_a_(Items.NETHERITE_SHOVEL, StockModelShapes.field_240274_aL_);
        this.func_240076_a_(Items.NETHERITE_SWORD, StockModelShapes.field_240274_aL_);
        ...
        this.func_240076_a_(Items.PIGLIN_BANNER_PATTERN, StockModelShapes.field_240273_aK_);

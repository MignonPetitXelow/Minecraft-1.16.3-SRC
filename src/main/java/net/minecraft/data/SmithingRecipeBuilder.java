...
public class SmithingRecipeBuilder
{
    ...
    public void func_240505_a_(Consumer<IFinishedRecipe> p_240505_1_, ResourceLocation p_240505_2_)
    {
        ...
        this.field_240500_d_.withParentId(new ResourceLocation("recipes/root")).withCriterion("has_the_recipe", RecipeUnlockedTrigger.create(p_240505_2_)).withRewards(AdvancementRewards.Builder.recipe(p_240505_2_)).withRequirementsStrategy(IRequirementsStrategy.OR);

...
public class RegistryDumpReport implements IDataProvider
{
    ...
    public void act(DirectoryCache cache) throws IOException
    {
        ...
        {
            jsonobject.add(p_218431_1_.toString(), func_239828_a_(Registry.REGISTRY.getOrDefault(p_218431_1_)));
        });
    ...
    private static <T> JsonElement func_239828_a_(Registry<T> p_239828_0_)
    {
        JsonObject jsonobject = new JsonObject();
        ...
        {
            T t = p_239828_0_.getOrDefault(resourcelocation1);

...
public class EntityTypeTagsProvider extends TagsProvider < EntityType<? >>
{
    ...
    protected void registerTags()
    {
        ...
        this.getOrCreateBuilder(EntityTypeTags.field_232893_e_).addTag(EntityTypeTags.ARROWS).add(EntityType.SNOWBALL, EntityType.FIREBALL, EntityType.SMALL_FIREBALL, EntityType.EGG, EntityType.TRIDENT, EntityType.DRAGON_FIREBALL, EntityType.WITHER_SKULL);
    }

...
public class ItemTagsProvider extends TagsProvider<Item>
{
    ...
    protected void registerTags()
    {
        ...
        this.copy(BlockTags.CRIMSON_STEMS, ItemTags.field_232913_w_);
        this.copy(BlockTags.WARPED_STEMS, ItemTags.field_232914_x_);
        this.copy(BlockTags.LOGS_THAT_BURN, ItemTags.field_232912_o_);
        ...
        this.copy(BlockTags.GOLD_ORES, ItemTags.field_232904_O_);
        this.copy(BlockTags.SOUL_FIRE_BASE_BLOCKS, ItemTags.field_232906_Q_);
        ...
        this.getOrCreateBuilder(ItemTags.field_232907_V_).add(Items.MUSIC_DISC_13, Items.MUSIC_DISC_CAT, Items.MUSIC_DISC_BLOCKS, Items.MUSIC_DISC_CHIRP, Items.MUSIC_DISC_FAR, Items.MUSIC_DISC_MALL, Items.MUSIC_DISC_MELLOHI, Items.MUSIC_DISC_STAL, Items.MUSIC_DISC_STRAD, Items.MUSIC_DISC_WARD, Items.MUSIC_DISC_11, Items.MUSIC_DISC_WAIT);
        this.getOrCreateBuilder(ItemTags.MUSIC_DISCS).addTag(ItemTags.field_232907_V_).addItemEntry(Items.MUSIC_DISC_PIGSTEP);

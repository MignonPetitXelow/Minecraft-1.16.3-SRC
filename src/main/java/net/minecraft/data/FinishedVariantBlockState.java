...
public class FinishedVariantBlockState implements IFinishedBlockState
{
    ...
    public JsonElement get()
    {
        ...
        {
            JsonElement jsonelement = map1.put(p_240129_1_.getFirst().func_240191_b_(), BlockModelDefinition.func_240199_a_(p_240129_1_.getSecond()));
        });
    ...
    private static List<BlockModelDefinition> func_240127_a_(List<BlockModelDefinition> p_240127_0_, List<BlockModelDefinition> p_240127_1_)
    {
        ...
        p_240127_0_.forEach((p_240126_2_) ->
        {
            p_240127_1_.forEach((p_240123_2_) -> {
                builder.add(BlockModelDefinition.func_240197_a_(p_240126_2_, p_240123_2_));
            });
        });
    ...
    {
        return new FinishedVariantBlockState(p_240119_0_, ImmutableList.of(BlockModelDefinition.func_240194_a_()));
    }

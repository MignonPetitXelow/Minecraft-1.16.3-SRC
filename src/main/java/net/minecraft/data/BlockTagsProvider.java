...
public class BlockTagsProvider extends TagsProvider<Block>
{
    ...
    protected void registerTags()
    {
        ...
        this.getOrCreateBuilder(BlockTags.field_242171_aD).addItemEntry(Blocks.MYCELIUM).addItemEntry(Blocks.PODZOL).addItemEntry(Blocks.CRIMSON_NYLIUM).addItemEntry(Blocks.WARPED_NYLIUM);
        ...
        this.getOrCreateBuilder(BlockTags.field_242172_aH).addItemEntry(Blocks.STONE).addItemEntry(Blocks.GRANITE).addItemEntry(Blocks.DIORITE).addItemEntry(Blocks.ANDESITE);
        this.getOrCreateBuilder(BlockTags.field_242173_aI).addItemEntry(Blocks.NETHERRACK).addItemEntry(Blocks.BASALT).addItemEntry(Blocks.BLACKSTONE);
    }

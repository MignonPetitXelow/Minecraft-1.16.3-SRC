...
public abstract class PathNavigator
{
    ...
    {
        return this.func_225464_a(ImmutableSet.of(entityIn.getPosition()), 16, true, p_75494_2_);
    }
    ...
    protected Path func_225464_a(Set<BlockPos> p_225464_1_, int p_225464_2_, boolean p_225464_3_, int p_225464_4_)
    {
        ...
        else
        {
            ...
            BlockPos blockpos = p_225464_3_ ? this.entity.getPosition().up() : this.entity.getPosition();
    ...
    private boolean func_234112_b_(Vector3d p_234112_1_)
    {
        ...
        else
        {
            ...
            if (!p_234112_1_.isWithinDistanceOf(vector3d, 2.0D))
            {
                return false;
            }
            else

...
public class CatEntity extends TameableEntity
{
    ...
    public ILivingEntityData onInitialSpawn(IServerWorld worldIn, DifficultyInstance difficultyIn, SpawnReason reason, @Nullable ILivingEntityData spawnDataIn, @Nullable CompoundNBT dataTag)
    {
        ...
        if (worldIn.func_242413_ae() > 0.9F)
        {
    ...
    static class MorningGiftGoal extends Goal
    {
        ...
        public boolean shouldExecute()
        {
            ...
            else if (this.cat.func_233685_eM_())
            {
                return false;
            }
            else
        ...
        public boolean shouldContinueExecuting()
        {
            return this.cat.isTamed() && !this.cat.func_233685_eM_() && this.owner != null && this.owner.isSleeping() && this.bedPos != null && !this.func_220805_g();
        }

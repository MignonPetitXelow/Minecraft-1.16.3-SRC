...
public abstract class LivingEntity extends Entity
{
    ...
    {
        return this.getBrainCodec().func_233748_a_(dynamicIn);
    }
    ...
    {
        return AttributeModifierMap.func_233803_a_().createMutableAttribute(Attributes.MAX_HEALTH).createMutableAttribute(Attributes.KNOCKBACK_RESISTANCE).createMutableAttribute(Attributes.MOVEMENT_SPEED).createMutableAttribute(Attributes.ARMOR).createMutableAttribute(Attributes.ARMOR_TOUGHNESS);
    }
    ...
    public void writeAdditional(CompoundNBT compound)
    {
        ...
        DataResult<INBT> dataresult = this.brain.func_233702_a_(NBTDynamicOps.INSTANCE);

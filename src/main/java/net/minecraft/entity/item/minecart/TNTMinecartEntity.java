...
public class TNTMinecartEntity extends AbstractMinecartEntity
{
    ...
    public TNTMinecartEntity(EntityType <? extends TNTMinecartEntity > p_i50112_1_, World world)
    {
        super(p_i50112_1_, world);
    }
    ...
    {
        return !this.isIgnited() || !blockStateIn.isIn(BlockTags.RAILS) && !worldIn.getBlockState(pos.up()).isIn(BlockTags.RAILS) ? super.getExplosionResistance(explosionIn, worldIn, pos, blockStateIn, p_180428_5_, explosionPower) : 0.0F;
    }

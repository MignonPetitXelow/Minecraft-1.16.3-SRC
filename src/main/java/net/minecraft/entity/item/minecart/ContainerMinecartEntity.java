...
public abstract class ContainerMinecartEntity extends AbstractMinecartEntity implements IInventory, INamedContainerProvider
{
    ...
    protected ContainerMinecartEntity(EntityType<?> p_i48536_1_, World world)
    {
        super(p_i48536_1_, world);
    }

    protected ContainerMinecartEntity(EntityType<?> p_i48537_1_, double x, double y, double z, World world)
    {
        super(p_i48537_1_, world, x, y, z);
    }

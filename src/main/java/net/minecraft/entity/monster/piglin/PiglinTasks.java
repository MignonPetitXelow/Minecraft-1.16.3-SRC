...
public class PiglinTasks
{
    ...
    {
        int i = field_234445_b_.func_233018_a_(p_234466_0_.world.rand);
        p_234466_0_.getBrain().func_233696_a_(MemoryModuleType.HUNTED_RECENTLY, true, (long)i);
    }

    private static void func_234464_a_(Brain<PiglinEntity> p_234464_0_)
    {
        p_234464_0_.func_233698_a_(Activity.CORE, 0, ImmutableList. < net.minecraft.entity.ai.brain.task.Task <? super PiglinEntity >> of(new LookTask(45, 90), new WalkToTargetTask(), new InteractWithDoorTask(), func_241428_d_(), func_234500_d_(), new StartAdmiringItemTask(), new AdmireItemTask(120), new EndAttackTask(300, PiglinTasks::func_234461_a_), new GetAngryTask()));
    }

    private static void func_234485_b_(Brain<PiglinEntity> p_234485_0_)
    {
        p_234485_0_.func_233698_a_(Activity.IDLE, 10, ImmutableList.of(new LookAtEntityTask(PiglinTasks::func_234482_b_, 14.0F), new ForgetAttackTargetTask<>(AbstractPiglinEntity::func_242337_eM, PiglinTasks::func_234526_m_), new SupplementedTask<>(PiglinEntity::func_234422_eK_, new StartHuntTask<>()), func_234493_c_(), func_234505_e_(), func_234458_a_(), func_234481_b_(), new FindInteractionAndLookTargetTask(EntityType.PLAYER, 4)));
    }
    ...
    {
        p_234495_0_.func_233699_a_(Activity.CELEBRATE, 10, ImmutableList. < net.minecraft.entity.ai.brain.task.Task <? super PiglinEntity >> of(func_234493_c_(), new LookAtEntityTask(PiglinTasks::func_234482_b_, 14.0F), new ForgetAttackTargetTask<PiglinEntity>(AbstractPiglinEntity::func_242337_eM, PiglinTasks::func_234526_m_), new SupplementedTask<PiglinEntity>((p_234457_0_) ->
        {
    ...
    {
        p_234502_0_.func_233699_a_(Activity.ADMIRE_ITEM, 10, ImmutableList. < net.minecraft.entity.ai.brain.task.Task <? super PiglinEntity >> of(new PickupWantedItemTask<>(PiglinTasks::func_234455_E_, 1.0F, true, 9), new ForgetAdmiredItemTask(9), new StopReachingItemTask(200, 200)), MemoryModuleType.ADMIRING_ITEM);
    }

    private static void func_234507_e_(Brain<PiglinEntity> p_234507_0_)
    {
        p_234507_0_.func_233699_a_(Activity.AVOID, 10, ImmutableList.of(RunAwayTask.func_233965_b_(MemoryModuleType.AVOID_TARGET, 1.0F, 12, true), func_234458_a_(), func_234481_b_(), new PredicateTask<PiglinEntity>(PiglinTasks::func_234533_t_, MemoryModuleType.AVOID_TARGET)), MemoryModuleType.AVOID_TARGET);
    }

    private static void func_234511_f_(Brain<PiglinEntity> p_234511_0_)
    {
        p_234511_0_.func_233699_a_(Activity.RIDE, 10, ImmutableList.of(new RideEntityTask<>(0.8F), new LookAtEntityTask(PiglinTasks::func_234482_b_, 8.0F), new SupplementedTask<>(Entity::isPassenger, func_234458_a_()), new StopRidingEntityTask<>(8, PiglinTasks::func_234467_a_)), MemoryModuleType.RIDE_TARGET);
    }
    ...
    protected static void func_234470_a_(PiglinEntity p_234470_0_, ItemEntity p_234470_1_)
    {
        ...
        {
            p_234470_0_.getBrain().removeMemory(MemoryModuleType.field_242310_O);
    ...
    private static void func_234476_a_(PiglinEntity p_234476_0_, List<ItemStack> p_234476_1_, Vector3d p_234476_2_)
    {
        if (!p_234476_1_.isEmpty())
        {
            ...
            {
                BrainUtil.func_233865_a_(p_234476_0_, itemstack, p_234476_2_.add(0.0D, 1.0D, 0.0D));
            }
        }
    }
    ...
    {
        return p_234480_0_.isIn(ItemTags.field_232903_N_);
    }
    ...
    {
        return p_241429_0_.getBrain().func_233716_f_().map((p_241426_1_) ->
        {
    ...
    protected static void func_234497_c_(AbstractPiglinEntity p_234497_0_, LivingEntity p_234497_1_)
    {
        if (func_234506_e_(p_234497_1_))
        {
            ...
            p_234497_0_.getBrain().func_233696_a_(MemoryModuleType.ANGRY_AT, p_234497_1_.getUniqueID(), 600L);
            ...
            {
                p_234497_0_.getBrain().func_233696_a_(MemoryModuleType.UNIVERSAL_ANGER, true, 600L);
            }
        }
    }
    ...
    private static void func_234513_f_(AbstractPiglinEntity p_234513_0_, LivingEntity p_234513_1_)
    {
        ...
        LivingEntity livingentity = BrainUtil.func_233867_a_(p_234513_0_, optional, p_234513_1_);
    ...
    {
        return BrainUtil.func_233864_a_(p_234532_0_, MemoryModuleType.ANGRY_AT);
    }
    ...
    private static void func_234521_i_(PiglinEntity p_234521_0_, LivingEntity p_234521_1_)
    {
        ...
        p_234521_0_.getBrain().func_233696_a_(MemoryModuleType.AVOID_TARGET, p_234521_1_, (long)field_234448_e_.func_233018_a_(p_234521_0_.world.rand));
        func_234518_h_(p_234521_0_);
    }

    protected static void func_234518_h_(AbstractPiglinEntity p_234518_0_)
    {
        p_234518_0_.getBrain().func_233696_a_(MemoryModuleType.HUNTED_RECENTLY, true, (long)field_234445_b_.func_233018_a_(p_234518_0_.world.rand));
    }

    private static void func_234536_x_(PiglinEntity p_234536_0_)
    {
        p_234536_0_.getBrain().func_233696_a_(MemoryModuleType.ATE_RECENTLY, true, 200L);
    }
    ...
    {
        p_234501_0_.getBrain().func_233696_a_(MemoryModuleType.ADMIRING_ITEM, true, 120L);
    }

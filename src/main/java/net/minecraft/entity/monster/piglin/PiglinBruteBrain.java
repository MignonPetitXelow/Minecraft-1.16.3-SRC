...
public class PiglinBruteBrain
{
    ...
    {
        p_242364_1_.func_233699_a_(Activity.FIGHT, 10, ImmutableList.of(new FindNewAttackTargetTask<>((p_242361_1_) ->
        {
    ...
    protected static void func_242358_b(PiglinBruteEntity p_242358_0_)
    {
        ...
        brain.func_233706_a_(ImmutableList.of(Activity.FIGHT, Activity.IDLE));
    ...
    {
        Optional<LivingEntity> optional = BrainUtil.func_233864_a_(p_242349_0_, MemoryModuleType.ANGRY_AT);

...
public class PiglinEntity extends AbstractPiglinEntity implements ICrossbowUser
{
    ...
    {
        return PiglinTasks.func_234469_a_(this, this.getBrainCodec().func_233748_a_(dynamicIn));
    }

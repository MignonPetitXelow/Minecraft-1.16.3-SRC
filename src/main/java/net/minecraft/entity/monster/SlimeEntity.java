...
public class SlimeEntity extends MobEntity implements IMob
{
    ...
    public static boolean func_223366_c(EntityType<SlimeEntity> p_223366_0_, IWorld p_223366_1_, SpawnReason reason, BlockPos p_223366_3_, Random randomIn)
    {
        ...
        {
            if (Objects.equals(p_223366_1_.func_242406_i(p_223366_3_), Optional.of(Biomes.SWAMP)) && p_223366_3_.getY() > 50 && p_223366_3_.getY() < 70 && randomIn.nextFloat() < 0.5F && randomIn.nextFloat() < p_223366_1_.func_242413_ae() && p_223366_1_.getLight(p_223366_3_) <= randomIn.nextInt(8))
            {

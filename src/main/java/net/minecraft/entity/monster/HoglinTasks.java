...
public class HoglinTasks
{
    ...
    private static void func_234390_d_(HoglinEntity p_234390_0_, LivingEntity p_234390_1_)
    {
        ...
        LivingEntity lvt_2_1_ = BrainUtil.func_233867_a_(p_234390_0_, brain.getMemory(MemoryModuleType.AVOID_TARGET), p_234390_1_);
        lvt_2_1_ = BrainUtil.func_233867_a_(p_234390_0_, brain.getMemory(MemoryModuleType.ATTACK_TARGET), lvt_2_1_);
    ...
    private static void func_234393_e_(HoglinEntity p_234393_0_, LivingEntity p_234393_1_)
    {
        ...
        p_234393_0_.getBrain().func_233696_a_(MemoryModuleType.AVOID_TARGET, p_234393_1_, (long)field_234372_a_.func_233018_a_(p_234393_0_.world.rand));
    }
    ...
    private static void func_234397_g_(HoglinEntity p_234397_0_, LivingEntity p_234397_1_)
    {
        ...
        brain.removeMemory(MemoryModuleType.BREED_TARGET);
        brain.func_233696_a_(MemoryModuleType.ATTACK_TARGET, p_234397_1_, 200L);
    }

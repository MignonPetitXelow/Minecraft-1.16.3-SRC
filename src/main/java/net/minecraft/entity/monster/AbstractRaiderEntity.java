...
public abstract class AbstractRaiderEntity extends PatrollerEntity
{
    ...
    static class InvadeHomeGoal extends Goal
    {
        ...
        private boolean func_220863_h()
        {
            ...
            BlockPos blockpos = this.field_220864_a.getPosition();
        ...
        public void tick()
        {
            if (this.field_220864_a.getNavigator().noPath())
            {
                Vector3d vector3d = Vector3d.copyCenteredHorizontally(this.field_220866_c);
                Vector3d vector3d1 = RandomPositionGenerator.findRandomTargetTowardsScaled(this.field_220864_a, 16, 7, vector3d, (double)((float)Math.PI / 10F));

                if (vector3d1 == null)
                {
                    vector3d1 = RandomPositionGenerator.findRandomTargetBlockTowards(this.field_220864_a, 8, 7, vector3d);
                }
                ...
                this.field_220864_a.getNavigator().tryMoveToXYZ(vector3d1.x, vector3d1.y, vector3d1.z, this.field_220865_b);
            }
        }

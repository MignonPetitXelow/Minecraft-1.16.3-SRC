...
public class ZoglinEntity extends MonsterEntity implements IMob, IFlinging
{
    ...
    {
        Brain<ZoglinEntity> brain = this.getBrainCodec().func_233748_a_(dynamicIn);
    ...
    {
        p_234330_0_.func_233699_a_(Activity.FIGHT, 10, ImmutableList. < net.minecraft.entity.ai.brain.task.Task <? super ZoglinEntity >> of(new MoveToTargetTask(1.0F), new SupplementedTask<>(ZoglinEntity::func_234331_eI_, new AttackTargetTask(40)), new SupplementedTask<>(ZoglinEntity::isChild, new AttackTargetTask(15)), new FindNewAttackTargetTask<>()), MemoryModuleType.ATTACK_TARGET);
    }
    ...
    public boolean attackEntityFrom(DamageSource source, float amount)
    {
        ...
        else if (flag && source.getTrueSource() instanceof LivingEntity)
        {
            ...
            if (EntityPredicates.CAN_HOSTILE_AI_TARGET.test(livingentity) && !BrainUtil.func_233861_a_(this, livingentity, 4.0D))
            {
    ...
    private void func_234338_k_(LivingEntity p_234338_1_)
    {
        ...
        this.brain.func_233696_a_(MemoryModuleType.ATTACK_TARGET, p_234338_1_, 200L);
    }
    ...
    protected void func_234332_eJ_()
    {
        ...
        this.brain.func_233706_a_(ImmutableList.of(Activity.FIGHT, Activity.IDLE));

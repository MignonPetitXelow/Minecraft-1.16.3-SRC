...
public class ServerPlayerEntity extends PlayerEntity implements IContainerListener
{
    ...
    public void writeAdditional(CompoundNBT compound)
    {
        ...
        compound.putString("Dimension", this.world.getDimensionKey().func_240901_a_().toString());
        ...
        if (this.field_241138_cr_ != null)
        {
            ...
            ResourceLocation.CODEC.encodeStart(NBTDynamicOps.INSTANCE, this.field_241137_cq_.func_240901_a_()).resultOrPartial(LOGGER::error).ifPresent((p_241148_1_) ->
            {
    ...
    public Entity changeDimension(ServerWorld server)
    {
        ...
        else
        {
            ...
            if (portalinfo != null)
            {
                ...
                this.setRotation(portalinfo.field_242960_c, portalinfo.field_242961_d);
    ...
    protected Optional<TeleportationRepositioner.Result> func_241830_a(ServerWorld p_241830_1_, BlockPos p_241830_2_, boolean p_241830_3_)
    {
        ...
        else
        {
            ...
            Optional<TeleportationRepositioner.Result> optional1 = p_241830_1_.getDefaultTeleporter().func_242956_a(p_241830_2_, direction$axis);
    ...
    public void teleport(ServerWorld newWorld, double x, double y, double z, float yaw, float pitch)
    {
        ...
        else
        {
            ...
            this.connection.sendPacket(new SRespawnPacket(newWorld.func_230315_m_(), newWorld.getDimensionKey(), BiomeManager.func_235200_a_(newWorld.getSeed()), this.interactionManager.getGameType(), this.interactionManager.func_241815_c_(), newWorld.isDebug(), newWorld.func_241109_A_(), true));
            this.connection.sendPacket(new SServerDifficultyPacket(iworldinfo.getDifficulty(), iworldinfo.isDifficultyLocked()));

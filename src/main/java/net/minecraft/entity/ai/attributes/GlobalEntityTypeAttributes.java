...
public class GlobalEntityTypeAttributes
{
    ...
    public static void func_233834_a_()
    {
        ...
        {
            return !doesEntityHaveAttributes(p_233838_0_);

...
public class ChildFollowNearestAdultTask<E extends AgeableEntity> extends Task<E>
{
    ...
    protected boolean shouldExecute(ServerWorld worldIn, E owner)
    {
        ...
        else
        {
            ...
            return owner.isEntityInRange(ageableentity, (double)(this.field_233850_b_.func_233019_b_() + 1)) && !owner.isEntityInRange(ageableentity, (double)this.field_233850_b_.func_233016_a_());
        }
    }

...
public class FindPotentialJobTask extends Task<VillagerEntity>
{
    ...
    {
        return owner.getBrain().func_233716_f_().map((activity) ->
        {
    ...
    {
        BrainUtil.func_233866_a_(owner, owner.getBrain().getMemory(MemoryModuleType.POTENTIAL_JOB_SITE).get().getPos(), this.speed, 1);
    }

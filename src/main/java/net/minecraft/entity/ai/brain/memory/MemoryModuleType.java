...
public class MemoryModuleType<U>
{
    ...
    public static final MemoryModuleType<Boolean> field_242309_E = registerWithCodec("golem_detected_recently", Codec.BOOL);
    ...
    {
        this.memoryCodec = p_i50306_1_.map(Memory::func_234066_a_);
    }

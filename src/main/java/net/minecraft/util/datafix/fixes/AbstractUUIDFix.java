...
public abstract class AbstractUUIDFix extends DataFix
{
    ...
    protected TypeReference field_233052_b_;

    public AbstractUUIDFix(Schema p_i231444_1_, TypeReference p_i231444_2_)
    {
        super(p_i231444_1_, false);
        this.field_233052_b_ = p_i231444_2_;
    }

    protected Typed<?> func_233053_a_(Typed<?> p_233053_1_, String p_233053_2_, Function < Dynamic<?>, Dynamic<? >> p_233053_3_)
    {
        Type<?> type = this.getInputSchema().getChoiceType(this.field_233052_b_, p_233053_2_);
        Type<?> type1 = this.getOutputSchema().getChoiceType(this.field_233052_b_, p_233053_2_);

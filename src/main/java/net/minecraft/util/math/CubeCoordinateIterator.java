...
public class CubeCoordinateIterator
{
    ...
    public CubeCoordinateIterator(int startX, int startY, int startZ, int xWidth, int yHeight, int zWidth)
    {
        this.startX = startX;
        this.startY = startY;
        this.startZ = startZ;
        this.xWidth = xWidth - startX + 1;
        this.yHeight = yHeight - startY + 1;
        this.zWidth = zWidth - startZ + 1;

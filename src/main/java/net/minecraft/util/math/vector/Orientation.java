...
public enum Orientation implements IStringSerializable
{
    ...
    public Direction func_235530_a_(Direction p_235530_1_)
    {
        if (this.field_235519_Y_ == null)
        {
            ...
            for (Direction direction : Direction.values())
            {
                ...
                Direction.AxisDirection direction$axisdirection1 = this.func_235529_a_(direction$axis1) ? direction$axisdirection.inverted() : direction$axisdirection;
    ...
    public boolean func_235529_a_(Direction.Axis p_235529_1_)
    {
        switch (p_235529_1_)
        {
            case X:

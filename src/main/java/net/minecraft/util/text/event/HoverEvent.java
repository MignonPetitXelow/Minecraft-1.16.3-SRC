...
public class HoverEvent
{
    ...
    public static HoverEvent deserialize(JsonObject json)
    {
        ...
        else
        {
            ...
            else
            {
                ...
                {
                    ITextComponent itextcomponent = ITextComponent.Serializer.func_240641_a_(json.get("value"));
    ...
    {
        public static final HoverEvent.Action<ITextComponent> SHOW_TEXT = new HoverEvent.Action<>("show_text", true, ITextComponent.Serializer::func_240641_a_, ITextComponent.Serializer::toJsonTree, Function.identity());
        ...
        public Action(String canonicalName, boolean allowedInChat, Function<JsonElement, T> p_i232565_3_, Function<T, JsonElement> p_i232565_4_, Function<ITextComponent, T> p_i232565_5_)
        {
        ...
        {
            T t = this.field_240665_g_.apply(element);
        ...
        {
            T t = this.field_240667_i_.apply(component);
            return t == null ? null : new HoverEvent(this, t);
        }
    ...
    public static class EntityHover
    {
        ...
        public List<ITextComponent> getTooltip()
        {
            if (this.field_240680_d_ == null)
            {
                ...
                this.field_240680_d_.add(new TranslationTextComponent("gui.entity_tooltip.type", this.type.getName()));

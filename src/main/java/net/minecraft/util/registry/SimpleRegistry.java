...
public class SimpleRegistry<T> extends MutableRegistry<T>
{
    ...
    public static <T> MapCodec<SimpleRegistry.Entry<T>> func_243541_a(RegistryKey <? extends Registry<T >> p_243541_0_, MapCodec<T> p_243541_1_)
    {
        ...
        {
            return p_243542_2_.group(ResourceLocation.CODEC.xmap(RegistryKey.func_240902_a_(p_243541_0_), RegistryKey::func_240901_a_).fieldOf("name").forGetter((p_243545_0_) -> {
    ...
    {
        return Codec.unboundedMap(ResourceLocation.CODEC.xmap(RegistryKey.func_240902_a_(registryKey), RegistryKey::func_240901_a_), mapCodec).xmap((p_239656_2_) ->
        {
            SimpleRegistry<T> simpleregistry = new SimpleRegistry<>(registryKey, lifecycle);
            p_239656_2_.forEach((p_239653_2_, p_239653_3_) -> {
                simpleregistry.register(p_239653_2_, p_239653_3_, lifecycle);
            });
            return simpleregistry;
        }, (p_239651_0_) ->
        {

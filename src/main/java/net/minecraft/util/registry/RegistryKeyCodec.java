...
public final class RegistryKeyCodec<E> implements Codec<Supplier<E>>
{
    ...
    public static <E> RegistryKeyCodec<E> func_241794_a_(RegistryKey <? extends Registry<E >> registryKey, Codec<E> codec)
    {
        return func_244325_a(registryKey, codec, true);
    }
    ...
    private RegistryKeyCodec(RegistryKey <? extends Registry<E >> p_i242090_1_, Codec<E> p_i242090_2_, boolean p_i242090_3_)
    {
        ...
        this.registryCodec = p_i242090_2_;
    ...
    {
        return p_encode_2_ instanceof WorldGenSettingsExport ? ((WorldGenSettingsExport)p_encode_2_).func_241811_a_(p_encode_1_.get(), p_encode_3_, this.registryKey, this.registryCodec) : this.registryCodec.encode(p_encode_1_.get(), p_encode_2_, p_encode_3_);
    }

    public <T> DataResult<Pair<Supplier<E>, T>> decode(DynamicOps<T> p_decode_1_, T p_decode_2_)
    {
        return p_decode_1_ instanceof WorldSettingsImport ? ((WorldSettingsImport)p_decode_1_).func_241802_a_(p_decode_2_, this.registryKey, this.registryCodec, this.field_244322_c) : this.registryCodec.decode(p_decode_1_, p_decode_2_).map((p_240866_0_) ->
        {

...
public abstract class CommandBlockLogic implements ICommandSource
{
    ...
    public void read(CompoundNBT nbt)
    {
        ...
        {
            this.setName(ITextComponent.Serializer.func_240643_a_(nbt.getString("CustomName")));
        }
        ...
        if (nbt.contains("LastOutput", 8) && this.trackOutput)
        {
            try
            {
                this.lastOutput = ITextComponent.Serializer.func_240643_a_(nbt.getString("LastOutput"));
            }

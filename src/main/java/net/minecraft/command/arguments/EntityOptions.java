            ...
            register("type", (p_197447_0_) ->
            {
                ...
                if (p_197447_0_.isTypeLimitedInversely() && !flag)
                {
                    ...
                    if (p_197447_0_.func_218115_f())
                    {
                        ...
                        {
                            return p_239573_2_.getServer().func_244266_aF().func_241838_d().func_241834_b(resourcelocation).contains(p_239573_2_.getType()) != flag;
                        });
                    }
                    else {
                        ResourceLocation resourcelocation1 = ResourceLocation.read(p_197447_0_.getReader());
                        EntityType<?> entitytype = Registry.ENTITY_TYPE.func_241873_b(resourcelocation1).orElseThrow(() -> {
                            p_197447_0_.getReader().setCursor(i);

...
public class AttributeCommand
{
    ...
    private static ModifiableAttributeInstance func_241002_a_(Entity p_241002_0_, Attribute p_241002_1_) throws CommandSyntaxException
    {
        ...
        {
            throw field_240998_c_.create(p_241002_0_.getName(), new TranslationTextComponent(p_241002_1_.func_233754_c_()));
        }
        else
        {
    ...
    private static LivingEntity func_241014_b_(Entity p_241014_0_, Attribute p_241014_1_) throws CommandSyntaxException
    {
        ...
        {
            throw field_240998_c_.create(p_241014_0_.getName(), new TranslationTextComponent(p_241014_1_.func_233754_c_()));
        }
        else
        {
            return livingentity;
    ...
    private static int func_241007_a_(CommandSource p_241007_0_, Entity p_241007_1_, Attribute p_241007_2_, double p_241007_3_) throws CommandSyntaxException
    {
        ...
        p_241007_0_.sendFeedback(new TranslationTextComponent("commands.attribute.value.get.success", new TranslationTextComponent(p_241007_2_.func_233754_c_()), p_241007_1_.getName(), d0), false);
    ...
    private static int func_241016_b_(CommandSource p_241016_0_, Entity p_241016_1_, Attribute p_241016_2_, double p_241016_3_) throws CommandSyntaxException
    {
        ...
        p_241016_0_.sendFeedback(new TranslationTextComponent("commands.attribute.base_value.get.success", new TranslationTextComponent(p_241016_2_.func_233754_c_()), p_241016_1_.getName(), d0), false);
    ...
    private static int func_241009_a_(CommandSource p_241009_0_, Entity p_241009_1_, Attribute p_241009_2_, UUID p_241009_3_, double p_241009_4_) throws CommandSyntaxException
    {
        ...
        {
            throw field_240999_d_.create(p_241009_1_.getName(), new TranslationTextComponent(p_241009_2_.func_233754_c_()), p_241009_3_);
        }
        else
        {
            double d0 = attributemodifiermanager.getModifierValue(p_241009_2_, p_241009_3_);
            p_241009_0_.sendFeedback(new TranslationTextComponent("commands.attribute.modifier.value.get.success", p_241009_3_, new TranslationTextComponent(p_241009_2_.func_233754_c_()), p_241009_1_.getName(), d0), false);
    ...
    private static int func_241019_c_(CommandSource p_241019_0_, Entity p_241019_1_, Attribute p_241019_2_, double p_241019_3_) throws CommandSyntaxException
    {
        ...
        p_241019_0_.sendFeedback(new TranslationTextComponent("commands.attribute.base_value.set.success", new TranslationTextComponent(p_241019_2_.func_233754_c_()), p_241019_1_.getName(), p_241019_3_), false);
        return 1;
    }
    ...
    private static int func_241010_a_(CommandSource p_241010_0_, Entity p_241010_1_, Attribute p_241010_2_, UUID p_241010_3_, String p_241010_4_, double p_241010_5_, AttributeModifier.Operation p_241010_7_) throws CommandSyntaxException
    {
        ...
        {
            throw field_241000_e_.create(p_241010_1_.getName(), new TranslationTextComponent(p_241010_2_.func_233754_c_()), p_241010_3_);
        }
        else
        {
            modifiableattributeinstance.applyPersistentModifier(attributemodifier);
            p_241010_0_.sendFeedback(new TranslationTextComponent("commands.attribute.modifier.add.success", p_241010_3_, new TranslationTextComponent(p_241010_2_.func_233754_c_()), p_241010_1_.getName()), false);
            return 1;
        }
    }
    ...
    private static int func_241008_a_(CommandSource p_241008_0_, Entity p_241008_1_, Attribute p_241008_2_, UUID p_241008_3_) throws CommandSyntaxException
    {
        ...
        {
            p_241008_0_.sendFeedback(new TranslationTextComponent("commands.attribute.modifier.remove.success", p_241008_3_, new TranslationTextComponent(p_241008_2_.func_233754_c_()), p_241008_1_.getName()), false);
            return 1;
        }
        else
        {
            throw field_240999_d_.create(p_241008_1_.getName(), new TranslationTextComponent(p_241008_2_.func_233754_c_()), p_241008_3_);
        }
    }
}

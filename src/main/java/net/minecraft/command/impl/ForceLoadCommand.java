...
public class ForceLoadCommand
{
    ...
    private static int doQuery(CommandSource p_212713_0_, ColumnPos p_212713_1_) throws CommandSyntaxException
    {
        ...
        if (flag)
        {
            p_212713_0_.sendFeedback(new TranslationTextComponent("commands.forceload.query.success", chunkpos, registrykey.func_240901_a_()), false);
            return 1;
        }
        else
        {
            throw QUERY_FAILURE_EXCEPTION.create(chunkpos, registrykey.func_240901_a_());
        }
    }
    ...
    private static int doList(CommandSource p_212721_0_)
    {
        ...
        if (i > 0)
        {
            ...
            if (i == 1)
            {
                p_212721_0_.sendFeedback(new TranslationTextComponent("commands.forceload.list.single", registrykey.func_240901_a_(), s), false);
            }
            else
            {
                p_212721_0_.sendFeedback(new TranslationTextComponent("commands.forceload.list.multiple", i, registrykey.func_240901_a_(), s), false);
            }
        }
        else
        {
            p_212721_0_.sendErrorMessage(new TranslationTextComponent("commands.forceload.added.none", registrykey.func_240901_a_()));
        }
    ...
    private static int removeAll(CommandSource p_212722_0_)
    {
        ...
        p_212722_0_.sendFeedback(new TranslationTextComponent("commands.forceload.removed.all", registrykey.func_240901_a_()), true);
        return 0;
    }
        ...
        if (i >= -30000000 && j >= -30000000 && k < 30000000 && l < 30000000)
        {
            ...
            else
            {
                ...
                else
                {
                    if (j2 == 1)
                    {
                        p_212719_0_.sendFeedback(new TranslationTextComponent("commands.forceload." + (p_212719_3_ ? "added" : "removed") + ".single", chunkpos, registrykey.func_240901_a_()), true);
                    }
                    else
                    {
                        ChunkPos chunkpos1 = new ChunkPos(i1, j1);
                        ChunkPos chunkpos2 = new ChunkPos(k1, l1);
                        p_212719_0_.sendFeedback(new TranslationTextComponent("commands.forceload." + (p_212719_3_ ? "added" : "removed") + ".multiple", j2, registrykey.func_240901_a_(), chunkpos1, chunkpos2), true);
                    }

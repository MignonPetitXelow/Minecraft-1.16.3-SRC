...
public class Config
{
    ...
    public static final String OF_RELEASE = "G4_pre1";
    public static final String VERSION = "OptiFine_1.16.3_HD_U_G4_pre1";
    ...
    {
        return "OptiFine_1.16.3_HD_U_G4_pre1";
    }
    ...
    public static String getVersionDebug()
    {
        ...
        stringbuffer.append("OptiFine_1.16.3_HD_U_G4_pre1");
    ...
    public static int getMinecraftVersionInt()
    {
        ...
        {
            String[] astring = tokenize("1.16.3", ".");
            int i = 0;
    ...
    public static void drawFps(MatrixStack matrixStackIn)
    {
        ...
        int j = getFpsMin();
        int k = getChunkUpdates();
        int l = minecraft.worldRenderer.getCountActiveRenderers();
        int i1 = minecraft.worldRenderer.getCountEntitiesRendered();
        int j1 = minecraft.worldRenderer.getCountTileEntitiesRendered();
        String s = "" + i + "/" + j + " fps, C: " + l + ", E: " + i1 + "+" + j1 + ", U: " + k;

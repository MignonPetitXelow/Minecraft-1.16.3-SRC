...
public class BiomeUtils
{
    ...
    public static Biome PLAINS = biomeRegistry.func_243576_d(Biomes.PLAINS);
    public static Biome SWAMP = biomeRegistry.func_243576_d(Biomes.SWAMP);
    public static Biome SWAMP_HILLS = biomeRegistry.func_243576_d(Biomes.SWAMP_HILLS);

    public static void onWorldChanged(World worldIn)
    {
        biomeRegistry = getBiomeRegistry(worldIn);
        PLAINS = biomeRegistry.func_243576_d(Biomes.PLAINS);
        SWAMP = biomeRegistry.func_243576_d(Biomes.SWAMP);
        SWAMP_HILLS = biomeRegistry.func_243576_d(Biomes.SWAMP_HILLS);
    }

    public static Registry<Biome> getBiomeRegistry(World worldIn)
    {
        return worldIn != null ? worldIn.func_241828_r().func_243612_b(Registry.BIOME_KEY) : DynamicRegistries.func_239770_b_().func_243612_b(Registry.BIOME_KEY);
    }

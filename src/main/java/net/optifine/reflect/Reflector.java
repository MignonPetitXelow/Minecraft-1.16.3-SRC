...
public class Reflector
{
    ...
    public static ReflectorClass IForgeDimension = new ReflectorClass("net.minecraftforge.common.extensions.IForgeDimension");
    public static ReflectorMethod IForgeDimension_getCloudRenderer = new ReflectorMethod(IForgeDimension, "getCloudRenderer");
    public static ReflectorMethod IForgeDimension_getSkyRenderer = new ReflectorMethod(IForgeDimension, "getSkyRenderer");
    public static ReflectorMethod IForgeDimension_getWeatherRenderer = new ReflectorMethod(IForgeDimension, "getWeatherRenderer");
    public static ReflectorMethod IForgeDimension_getLightmapColors = new ReflectorMethod(IForgeDimension, "getLightmapColors");
    public static ReflectorMethod IForgeDimension_initCapabilities = new ReflectorMethod(IForgeDimension, "initCapabilities");

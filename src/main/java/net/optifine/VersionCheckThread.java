...
public class VersionCheckThread extends Thread
{
    ...
    public void run()
    {
        ...
        try
        {
            ...
            URL url = new URL("http://optifine.net/version/1.16.3/HD_U.txt");
            httpurlconnection = (HttpURLConnection)url.openConnection();

            if (Config.getGameSettings().snooper)
            {
                httpurlconnection.setRequestProperty("OF-MC-Version", "1.16.3");
                ...
                httpurlconnection.setRequestProperty("OF-Release", "G4_pre1");
            ...
            try
            {
                ...
                if (astring.length >= 1)
                {
                    ...
                    if (Config.compareRelease(s1, "G4_pre1") <= 0)
                    {
                        return;
                    }
